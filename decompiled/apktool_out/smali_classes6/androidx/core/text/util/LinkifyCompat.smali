...
.method public static addLinks(Landroid/text/Spannable;I)Z
    ...
    const-string v8, "58505d"

    const/16 v9, 0x7110

    invoke-static {v1, v8, v9}, Ln/NPStringFog;->decode([BLjava/lang/String;I)Ljava/lang/String;
    ...
    const-string v8, "028bb4"

    invoke-static {v1, v8, v7}, Ln/NPStringFog;->decode([BLjava/lang/String;Z)Ljava/lang/String;
    ...
    const-string v9, "188a7f"

    invoke-static {v8, v9, v6, v7}, Ln/NPStringFog;->decode([BLjava/lang/String;ZZ)Ljava/lang/String;
    ...
    const-string v4, "4e8a47"

    const/16 v8, -0x58f3

    invoke-static {v1, v4, v8}, Ln/NPStringFog;->decode([BLjava/lang/String;I)Ljava/lang/String;
...
.method private static gatherMapLinks(Ljava/util/ArrayList;Landroid/text/Spannable;)V
    ...
    iput v3, v4, Landroidx/core/text/util/LinkifyCompat$LinkSpec;->end:I
...
.method private static pruneOverlaps(Ljava/util/ArrayList;Landroid/text/Spannable;)V
    ...
    iput-object v5, v3, Landroidx/core/text/util/LinkifyCompat$LinkSpec;->frameworkAddedSpan:Landroid/text/style/URLSpan;
    ...
    iput v5, v3, Landroidx/core/text/util/LinkifyCompat$LinkSpec;->start:I
    ...
    iput v5, v3, Landroidx/core/text/util/LinkifyCompat$LinkSpec;->end:I
    ...
    iget v5, v0, Landroidx/core/text/util/LinkifyCompat$LinkSpec;->end:I
