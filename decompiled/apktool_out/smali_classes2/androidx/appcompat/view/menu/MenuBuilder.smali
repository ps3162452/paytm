...
.method static constructor <clinit>()V
    ...
    const-string v1, "443f94"

    const-wide v2, -0x3e2bd27d07c00000L    # -1.354107873E9
    ...
    const-string v1, "87e6ff"

    const-wide/32 v2, -0x7a21cf5f
    ...
    const-string v1, "4492e5"

    const-wide v2, 0x4180eef280000000L    # 3.5511888E7
...
.method private dispatchPresenterUpdate(Z)V
    ...
    :cond_1
    invoke-interface {v1, p1}, Landroidx/appcompat/view/menu/MenuPresenter;->updateMenuView(Z)V
...
.method private dispatchRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    sget-object v0, Landroidx/appcompat/view/menu/MenuBuilder;->PRESENTER_KEY:Ljava/lang/String;
...
.method private dispatchSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;Landroidx/appcompat/view/menu/MenuPresenter;)Z
    ...
    invoke-interface {v1, p1}, Landroidx/appcompat/view/menu/MenuPresenter;->onSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;)Z
...
.method public addIntentOptions(IIILandroid/content/ComponentName;[Landroid/content/Intent;Landroid/content/Intent;I[Landroid/view/MenuItem;)I
    ...
    invoke-virtual {p0, p1, p2, p3, v1}, Landroidx/appcompat/view/menu/MenuBuilder;->add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
...
.method public final close(Z)V
    ...
    :cond_1
    invoke-interface {v1, p0, p1}, Landroidx/appcompat/view/menu/MenuPresenter;->onCloseMenu(Landroidx/appcompat/view/menu/MenuBuilder;Z)V
...
.method findItemWithShortcutForKey(ILandroid/view/KeyEvent;)Landroidx/appcompat/view/menu/MenuItemImpl;
    ...
    iget-object v5, p0, Landroidx/appcompat/view/menu/MenuBuilder;->mTempShortcutItemList:Ljava/util/ArrayList;

    invoke-virtual {v5}, Ljava/util/ArrayList;->clear()V

    invoke-virtual {p0, v5, p1, p2}, Landroidx/appcompat/view/menu/MenuBuilder;->findItemsWithShortcutForKey(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/MenuItemImpl;->getAlphabeticShortcut()C
    ...
    :cond_6
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/MenuItemImpl;->getNumericShortcut()C
...
.method findItemsWithShortcutForKey(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    invoke-virtual {v1, p1, p2, p3}, Landroidx/appcompat/view/menu/MenuBuilder;->findItemsWithShortcutForKey(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/MenuItemImpl;->getAlphabeticModifiers()I
    ...
    :cond_6
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/MenuItemImpl;->getNumericModifiers()I
...
.method public flagActionItems()V
    ...
    iget-boolean v0, p0, Landroidx/appcompat/view/menu/MenuBuilder;->mIsActionItemsStale:Z
...
.method protected getActionViewStatesKey()Ljava/lang/String;
    ...
    sget-object v0, Landroidx/appcompat/view/menu/MenuBuilder;->ACTION_VIEW_STATES_KEY:Ljava/lang/String;
...
.method public performItemAction(Landroid/view/MenuItem;Landroidx/appcompat/view/menu/MenuPresenter;I)Z
    ...
    invoke-direct {v0, v5, p0, p1}, Landroidx/appcompat/view/menu/SubMenuBuilder;-><init>(Landroid/content/Context;Landroidx/appcompat/view/menu/MenuBuilder;Landroidx/appcompat/view/menu/MenuItemImpl;)V

    invoke-virtual {p1, v0}, Landroidx/appcompat/view/menu/MenuItemImpl;->setSubMenu(Landroidx/appcompat/view/menu/SubMenuBuilder;)V
    ...
    :cond_7
    invoke-direct {p0, v0, p2}, Landroidx/appcompat/view/menu/MenuBuilder;->dispatchSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;Landroidx/appcompat/view/menu/MenuPresenter;)Z
...
.method public removeGroup(I)V
    ...
    invoke-direct {p0, v3, v2}, Landroidx/appcompat/view/menu/MenuBuilder;->removeItemAtInt(IZ)V
...
.method public restoreActionViewStates(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/SubMenuBuilder;->restoreActionViewStates(Landroid/os/Bundle;)V
    ...
    :cond_4
    sget-object v0, Landroidx/appcompat/view/menu/MenuBuilder;->EXPANDED_ACTION_VIEW_ID:Ljava/lang/String;
...
.method public saveActionViewStates(Landroid/os/Bundle;)V
    ...
    sget-object v1, Landroidx/appcompat/view/menu/MenuBuilder;->EXPANDED_ACTION_VIEW_ID:Ljava/lang/String;
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/SubMenuBuilder;->saveActionViewStates(Landroid/os/Bundle;)V
...
.method setExclusiveItemChecked(Landroid/view/MenuItem;)V
    ...
    :goto_2
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/MenuItemImpl;->setCheckedInt(Z)V
...
.method public setGroupCheckable(IZZ)V
    ...
    invoke-virtual {v0, p3}, Landroidx/appcompat/view/menu/MenuItemImpl;->setExclusiveCheckable(Z)V

    invoke-virtual {v0, p2}, Landroidx/appcompat/view/menu/MenuItemImpl;->setCheckable(Z)Landroid/view/MenuItem;
...
.method public setGroupEnabled(IZ)V
    ...
    invoke-virtual {v0, p2}, Landroidx/appcompat/view/menu/MenuItemImpl;->setEnabled(Z)Landroid/view/MenuItem;
...
.method public setGroupVisible(IZ)V
    ...
    invoke-virtual {v0, p2}, Landroidx/appcompat/view/menu/MenuItemImpl;->setVisibleInt(Z)Z
