...
.method private verifyHostname(Ljava/lang/String;Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-static {p2, v7}, Lokhttp3/internal/tls/OkHostnameVerifier;->getSubjectAltNames(Ljava/security/cert/X509Certificate;I)Ljava/util/List;
    ...
    invoke-direct {v0, v3}, Lokhttp3/internal/tls/DistinguishedNameParser;-><init>(Ljavax/security/auth/x500/X500Principal;)V

    new-array v3, v7, [B

    fill-array-data v3, :array_0

    const-string v5, "6a122b"

    invoke-static {v3, v5, v1, v2}, Ln/NPStringFog;->decode([BLjava/lang/String;ZZ)Ljava/lang/String;
...
.method public verifyHostname(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v3, "cbdeb4"

    const-wide v4, -0x3e21aaec0c000000L    # -2.035568592E9
    ...
    const-string v3, "2b4f26"

    const-wide v4, 0x41d150d642400000L    # 1.162041609E9
    ...
    const-string v4, "edf57b"

    const-wide/32 v6, -0x5a319e5f
    ...
    const-string v4, "3d9011"

    const-wide v6, -0x3e4975a83d000000L    # -3.78165187E8
    ...
    const-string v4, "4da1e4"

    const v5, 0x4edf8162    # 1.8748992E9f
    ...
    invoke-virtual {p1, v9, v2}, Ljava/lang/String;->lastIndexOf(II)I
