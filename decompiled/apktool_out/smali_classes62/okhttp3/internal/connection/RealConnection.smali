...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    sget-object v1, Lokhttp3/internal/connection/RealConnection;->NPE_THROW_WITH_NULL:Ljava/lang/String;
...
.method private connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    const-string v5, "0ad217"

    const-wide/32 v6, -0x5e382ec0
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    const-string v3, "8c550c"

    const-wide/32 v6, -0x7d851227
    ...
    const-string v2, "24d15d"

    const-wide/32 v4, -0x55cd2172
...
.method private createTunnelRequest()Lokhttp3/Request;
    ...
    const-string v2, "12a6b0"

    const v3, 0x4ebdb730    # 1.5914496E9f
...
.method public connect(IIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    const-string v2, "7dc441"

    const-wide/32 v4, 0x4bac4464
    ...
    const-string v3, "6411ee"

    const v4, 0x4edaecd3    # 1.8364768E9f
    ...
    const-string v5, "a8e25c"

    const-wide v6, 0x41c2d865ea000000L    # 6.32343508E8
    ...
    :cond_5
    invoke-direct {p0, v7, p5, p6}, Lokhttp3/internal/connection/RealConnection;->establishProtocol(Lokhttp3/internal/connection/ConnectionSpecSelector;Lokhttp3/Call;Lokhttp3/EventListener;)V
...
.method public toString()Ljava/lang/String;
    ...
    const-string v2, "418a7f"

    const-wide v4, -0x3e283a3673800000L    # -1.595352626E9
