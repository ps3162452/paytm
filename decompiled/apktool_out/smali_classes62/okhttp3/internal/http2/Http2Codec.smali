...
.method static constructor <clinit>()V
    ...
    const-string v1, "4bb6ac"

    const-wide/32 v2, -0x43549c5d
    ...
    const-string v1, "b5a91d"

    const-wide v2, -0x3e304acb42000000L    # -1.063938428E9
    ...
    const-string v1, "5e48e0"

    const v2, -0x318b4312    # -1.0265056E9f
...
.method public static http2HeadersList(Lokhttp3/Request;)Ljava/util/List;
    ...
    const-string v3, "901db1"

    const-wide/32 v4, -0x72647db1
...
.method public static readHttp2HeadersList(Ljava/util/List;)Lokhttp3/Response$Builder;
    ...
    const-string v7, "b38479"

    const-wide/32 v8, -0x6754fd0
    ...
    const-string v2, "2d3bb7"

    const v3, -0x3483044c    # -1.6579508E7f
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    const-string v2, "ddf38b"

    const-wide/32 v4, 0x1932843d
    ...
    new-instance v4, Lokhttp3/internal/http2/Http2Codec$StreamFinishingSource;

    iget-object v5, p0, Lokhttp3/internal/http2/Http2Codec;->stream:Lokhttp3/internal/http2/Http2Stream;

    invoke-virtual {v5}, Lokhttp3/internal/http2/Http2Stream;->getSource()Lokio/Source;

    move-result-object v5

    invoke-direct {v4, p0, v5}, Lokhttp3/internal/http2/Http2Codec$StreamFinishingSource;-><init>(Lokhttp3/internal/http2/Http2Codec;Lokio/Source;)V
