...
.method static constructor <clinit>()V
    ...
    const-string v1, "ce1357"

    const v2, 0x4e2f6d84    # 7.357975E8f
...
.method private load(Landroid/content/Context;I)V
    ...
    invoke-direct {v0, p1, v3}, Landroidx/constraintlayout/widget/ConstraintLayoutStates$State;-><init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v1, p0, Landroidx/constraintlayout/widget/ConstraintLayoutStates;->mStateList:Landroid/util/SparseArray;

    iget v4, v0, Landroidx/constraintlayout/widget/ConstraintLayoutStates$State;->mId:I
    ...
    const-string v5, "043f29"

    const-wide/32 v6, -0x23e595b0
    ...
    const-string v5, "162ed1"

    const-wide v6, 0x41d22febc7c00000L    # 1.220521759E9
    ...
    invoke-direct {v1, p1, v3}, Landroidx/constraintlayout/widget/ConstraintLayoutStates$Variant;-><init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
...
.method private parseConstraintSet(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    const-string v8, "0ce6bc"

    invoke-static {v7, v8, v2, v2}, Ln/NPStringFog;->decode([BLjava/lang/String;ZZ)Ljava/lang/String;
    ...
    :cond_2
    :goto_2
    invoke-virtual {v3, p1, p2}, Landroidx/constraintlayout/widget/ConstraintSet;->load(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v1, p0, Landroidx/constraintlayout/widget/ConstraintLayoutStates;->mConstraintSetMap:Landroid/util/SparseArray;
    ...
    :cond_4
    sget-object v1, Landroidx/constraintlayout/widget/ConstraintLayoutStates;->TAG:Ljava/lang/String;
    ...
    const-string v4, "e54e4e"

    const v5, 0x4eba9b77    # 1.5653754E9f
...
.method public updateConstraints(IFF)V
    ...
    :cond_2
    invoke-virtual {v1, p2, p3}, Landroidx/constraintlayout/widget/ConstraintLayoutStates$State;->findMatch(FF)I
    ...
    iget v0, v1, Landroidx/constraintlayout/widget/ConstraintLayoutStates$State;->mConstraintID:I
    ...
    iget-object v1, p0, Landroidx/constraintlayout/widget/ConstraintLayoutStates;->mConstraintsChangedListener:Landroidx/constraintlayout/widget/ConstraintsChangedListener;

    if-eqz v1, :cond_3

    invoke-virtual {v1, v4, v0}, Landroidx/constraintlayout/widget/ConstraintsChangedListener;->preLayoutChange(II)V

    :cond_3
    iget-object v1, p0, Landroidx/constraintlayout/widget/ConstraintLayoutStates;->mConstraintLayout:Landroidx/constraintlayout/widget/ConstraintLayout;
    ...
    invoke-virtual {v1, v4, v0}, Landroidx/constraintlayout/widget/ConstraintsChangedListener;->postLayoutChange(II)V
    ...
    iget-object v1, v0, Landroidx/constraintlayout/widget/ConstraintLayoutStates$State;->mConstraintSet:Landroidx/constraintlayout/widget/ConstraintSet;
    ...
    const-string v2, "61afb1"

    const-wide v4, -0x3e36c3e2d2800000L    # -8.46740059E8
    ...
    iget-object v2, p0, Landroidx/constraintlayout/widget/ConstraintLayoutStates;->mConstraintsChangedListener:Landroidx/constraintlayout/widget/ConstraintsChangedListener;

    if-eqz v2, :cond_a

    invoke-virtual {v2, p1, v0}, Landroidx/constraintlayout/widget/ConstraintsChangedListener;->preLayoutChange(II)V

    :cond_a
    iget-object v2, p0, Landroidx/constraintlayout/widget/ConstraintLayoutStates;->mConstraintLayout:Landroidx/constraintlayout/widget/ConstraintLayout;
    ...
    invoke-virtual {v1, p1, v0}, Landroidx/constraintlayout/widget/ConstraintsChangedListener;->postLayoutChange(II)V
