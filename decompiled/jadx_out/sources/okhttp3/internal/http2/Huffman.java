    ...
    private void addCode(int i, int i2, byte b) {
        ...
        while (true) {
            ...
            if (node3.children == null) {
                throw new IllegalStateException(NPStringFog.decode(new byte[]{11, 92, 66, 83, 88, 11, 6, 18, 80, 91, 87, 22, 11, 93, 90, 83, 70, 27, 88, 18, 68, 64, 81, 4, 11, 74, 20, 92, 91, 22, 66, 71, 90, 91, 69, 23, 7}, "b2424b", 919884695L));
            }
