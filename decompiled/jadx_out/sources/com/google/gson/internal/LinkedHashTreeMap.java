...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    static final class Node<K, V> implements Map.Entry<K, V> {
        ...
        public String toString() {
            return this.key + NPStringFog.decode(new byte[]{89}, "de465a", 230927588L) + this.value;
        }
    }
    ...
    Node<K, V> find(K k, boolean z) {
        ...
        if (node3 != null) {
            ...
            if (comparator == NATURAL_ORDER && !(k instanceof Comparable)) {
                throw new ClassCastException(k.getClass().getName() + NPStringFog.decode(new byte[]{16, 90, 16, 66, 91, 89, 68, 19, 32, 13, 88, 70, 81, 65, 2, 0, 89, 83}, "03cb56", 1102210359L));
            }
            node = new Node<>(node3, k, iSecondaryHash, node5, node5.prev);
            nodeArr[length] = node;
        }
    ...
    public V put(K k, V v) {
        if (k == null) {
            throw new NullPointerException(NPStringFog.decode(new byte[]{15, 1, 74, 65, 89, 8, 68, 10, 70, 13, 8}, "dd3ad5", false, true));
        }
