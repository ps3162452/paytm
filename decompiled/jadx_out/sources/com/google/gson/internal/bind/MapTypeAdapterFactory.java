        ...
        private String keyToString(JsonElement jsonElement) {
            if (!jsonElement.isJsonPrimitive()) {
                if (jsonElement.isJsonNull()) {
                    return NPStringFog.decode(new byte[]{92, 65, 13, 92}, "24a077", -9.707411E8f);
                }
        ...
        public Map<K, V> read2(JsonReader jsonReader) throws IOException {
            ...
            if (jsonTokenPeek != JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    if (mapConstruct.put(k, this.valueTypeAdapter.read2(jsonReader)) != null) {
                        throw new JsonSyntaxException(NPStringFog.decode(new byte[]{93, 65, 18, 10, 81, 83, 88, 64, 7, 70, 83, 85, 64, 14, 66}, "94bf80", false) + k);
                    }
                }
            ...
            while (jsonReader.hasNext()) {
                ...
                if (mapConstruct.put(k2, this.valueTypeAdapter.read2(jsonReader)) != null) {
                    throw new JsonSyntaxException(NPStringFog.decode(new byte[]{83, 77, 66, 93, 81, 84, 86, 76, 87, 17, 83, 82, 78, 2, 18}, "782187", true, false) + k2);
                }
                jsonReader.endArray();
            }
            jsonReader.endArray();
