...
public abstract class OneDReader implements Reader {
    ...
    */
    private com.google.zxing.Result doDecode(com.google.zxing.BinaryBitmap r17, java.util.Map<com.google.zxing.DecodeHintType, ?> r18) throws com.google.zxing.NotFoundException {
        /*
    ...
    public Result decode(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map) throws NotFoundException, FormatException {
        try {
            ...
            resultDoDecode.putMetadata(ResultMetadataType.ORIENTATION, Integer.valueOf((resultMetadata == null || !resultMetadata.containsKey(ResultMetadataType.ORIENTATION)) ? 270 : (((Integer) resultMetadata.get(ResultMetadataType.ORIENTATION)).intValue() + BarcodeUtils.ROTATION_270) % 360));
