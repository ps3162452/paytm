...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private void adjustOddEvenCounts(int i) throws NotFoundException {
        ...
        boolean z8 = (iCount & 1) == 1;
        boolean z9 = (iCount2 & 1) == 0;
        if (iCount > 13) {
            z = true;
            z2 = false;
        } else if (iCount < 4) {
    ...
    DataCharacter decodeDataCharacter(BitArray bitArray, FinderPattern finderPattern, boolean z, boolean z2) throws NotFoundException {
        ...
        for (int i3 = 0; i3 < dataCharacterCounters.length; i3++) {
            float f2 = (1.0f * dataCharacterCounters[i3]) / fCount;
            int i4 = (int) (0.5f + f2);
            if (i4 < 1) {
                if (f2 < 0.3f) {
                    throw NotFoundException.getNotFoundInstance();
        ...
        int value = ((z2 ? 0 : 1) + ((z ? 0 : 2) + (finderPattern.getValue() * 4))) - 1;
        int i6 = 0;
        ...
        return new DataCharacter(GSUM[i10] + RSSUtils.getRSSvalue(evenCounts, 9 - i11, false) + (RSSUtils.getRSSvalue(oddCounts, i11, true) * EVEN_TOTAL_SUBSET[i10]), i7 + i9);
    }
