...
final class FormatInformation {
    ...
    private static FormatInformation doDecodeFormatInformation(int i, int i2) {
        ...
        while (i5 < length) {
            ...
            int iNumBitsDiffering2 = numBitsDiffering(i, i7);
            if (iNumBitsDiffering2 < i4) {
                i3 = iArr2[1];
            } else {
                iNumBitsDiffering2 = i4;
                i3 = i6;
            }
            if (i == i2 || (iNumBitsDiffering = numBitsDiffering(i2, i7)) >= iNumBitsDiffering2) {
                iNumBitsDiffering = iNumBitsDiffering2;
            } else {
                i3 = iArr2[1];
            }
            i5++;
