...
public final class ExpandedProductParsedResult extends ParsedResult {
    public static final String KILOGRAM = NPStringFog.decode(new byte[]{122, 117}, "123a30", -1379309887L);
    public static final String POUND = NPStringFog.decode(new byte[]{125, 113}, "132d25", true, true);
