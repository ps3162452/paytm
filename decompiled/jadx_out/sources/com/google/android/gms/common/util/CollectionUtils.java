...
public final class CollectionUtils {
    ...
    public static <K, V> Map<K, V> mapOfKeyValueArrays(K[] kArr, V[] vArr) {
        ...
        if (length != length2) {
            throw new IllegalArgumentException(NPStringFog.decode(new byte[]{127, 6, 74, 17, 87, 86, 80, 67, 69, 80, 90, 77, 81, 16, 19, 80, 68, 74, 85, 26, 19, 93, 83, 86, 83, 23, 91, 66, 22, 86, 91, 23, 19, 84, 71, 77, 85, 15, 9, 17}, "4c3168", true, false) + length + NPStringFog.decode(new byte[]{24, 64, 13, 67}, "8a0c96", false, true) + length2);
        }
        switch (length) {
            case 0:
