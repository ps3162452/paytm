    ...
    private final Set zaa(Set set) {
        ...
        while (it.hasNext()) {
            if (!set.contains(it.next())) {
                throw new IllegalStateException(NPStringFog.decode(new byte[]{118, 76, 65, 4, 10, 93, 90, 90, 86, 69, 23, 90, 92, 68, 84, 22, 68, 80, 64, 20, 95, 10, 16, 25, 67, 81, 67, 8, 13, 77, 71, 81, 85, 73, 68, 76, 64, 81, 17, 12, 9, 73, 95, 93, 84, 1, 68, 74, 80, 91, 65, 0, 23, 25, 90, 90, 66, 17, 1, 88, 87}, "341ed9", 12128));
            }
        }
