...
public class PackageManagerWrapper {
    ...
    public final boolean zza(int i, String str) {
        if (PlatformVersion.isAtLeastKitKat()) {
            try {
                AppOpsManager appOpsManager = (AppOpsManager) this.zza.getSystemService(NPStringFog.decode(new byte[]{2, 19, 65, 93, 65, 17}, "cc121b", true, true));
                if (appOpsManager == null) {
                    throw new NullPointerException(NPStringFog.decode(new byte[]{80, 10, 15, 22, 84, 29, 71, 75, 6, 7, 69, 54, 74, 22, 21, 7, 92, 54, 86, 23, 23, 11, 82, 0, 27, 38, 14, 12, 69, 0, 75, 17, 79, 35, 97, 53, 108, 42, 49, 49, 110, 54, 118, 55, 55, 43, 114, 32, 26, 69, 8, 17, 17, 11, 70, 9, 13}, "3eab1e", 32009));
                }
