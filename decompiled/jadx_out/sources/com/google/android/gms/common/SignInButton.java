...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    private final void zaa(Context context) {
        ...
        try {
            ...
            Log.w(NPStringFog.decode(new byte[]{101, 13, 83, 92, 127, 15, 116, 17, 64, 70, 89, 15}, "6d426a", 1.2133674E9f), NPStringFog.decode(new byte[]{97, 93, 1, 10, 69, 8, 92, 20, 4, 17, 17, 21, 93, 90, 70, 10, 10, 21, 18, 82, 9, 17, 11, 5, 30, 20, 19, 23, 12, 15, 85, 20, 22, 8, 4, 2, 87, 92, 9, 8, 1, 4, 64, 20, 15, 10, 22, 21, 87, 85, 2}, "24fdea", 1.4805313E9f));
            int i = this.zaa;
            int i2 = this.zab;
