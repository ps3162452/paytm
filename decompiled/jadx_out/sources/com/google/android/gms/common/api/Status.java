...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    public String toString() {
        ...
        stringHelper.add(NPStringFog.decode(new byte[]{21, 67, 86, 65, 65, 22, 37, 88, 83, 80}, "f7754e", -1594969461L), zza());
        stringHelper.add(NPStringFog.decode(new byte[]{69, 84, 68, 13, 84, 66, 67, 88, 88, 12}, "717b87", -1.613345E9f), this.zze);
