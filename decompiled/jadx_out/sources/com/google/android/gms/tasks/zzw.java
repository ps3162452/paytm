...
final class zzw<TResult> extends Task<TResult> {
    ...
    private final void zzf() {
        Preconditions.checkState(this.zzc, NPStringFog.decode(new byte[]{101, 82, 17, 8, 17, 91, 66, 19, 12, 12, 69, 18, 72, 86, 22, 67, 82, 93, 92, 67, 14, 6, 69, 87}, "13bc12", 1.778139423E9d));
    }

    private final void zzg() {
        if (this.zzd) {
            throw new CancellationException(NPStringFog.decode(new byte[]{48, 84, 71, 9, 17, 81, 23, 21, 85, 14, 67, 93, 5, 81, 77, 66, 82, 89, 10, 86, 81, 14, 84, 92, 74}, "d54b18", -8.913602E8f));
        }
    }
    ...
    public final void zza(Exception exc) {
        Preconditions.checkNotNull(exc, NPStringFog.decode(new byte[]{35, 29, 0, 84, 69, 64, 15, 10, 13, 17, 88, 65, 21, 17, 67, 95, 90, 64, 70, 7, 6, 17, 91, 65, 10, 9}, "fec154", 8393));
        synchronized (this.zza) {
            zzh();
            this.zzc = true;
            this.zzf = exc;
    ...
    public final boolean zzd(Exception exc) {
        Preconditions.checkNotNull(exc, NPStringFog.decode(new byte[]{113, 75, 0, 87, 66, 21, 93, 92, 13, 18, 95, 20, 71, 71, 67, 92, 93, 21, 20, 81, 6, 18, 92, 20, 88, 95}, "43c22a", 1579614363L));
        synchronized (this.zza) {
            if (this.zzc) {
                return false;
            }
