...
public class MaterialDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void drawForHorizontalOrientation(Canvas canvas, RecyclerView recyclerView) {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            this.dividerDrawable.setBounds((iRound - this.dividerDrawable.getIntrinsicWidth()) - this.thickness, paddingTop + i, iRound, height - i2);
    ...
    private void drawForVerticalOrientation(Canvas canvas, RecyclerView recyclerView) {
        ...
        int i = z ? this.insetEnd : this.insetStart;
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            this.dividerDrawable.setBounds(paddingLeft + i, (iRound - this.dividerDrawable.getIntrinsicHeight()) - this.thickness, width - i2, iRound);
            this.dividerDrawable.draw(canvas);
        }
        canvas.restore();
    }
    ...
    public void setOrientation(int i) {
        if (i != 0 && i != 1) {
            throw new IllegalArgumentException(NPStringFog.decode(new byte[]{122, 94, 16, 3, 95, 90, 87, 16, 9, 16, 90, 86, 93, 68, 7, 22, 90, 92, 93, 10, 70}, "30fb33", false) + i + NPStringFog.decode(new byte[]{31, 20, 40, 66, 22, 75, 89, 91, 20, 90, 82, 24, 83, 81, 65, 83, 95, 76, 89, 81, 19, 22, 126, 119, 99, 125, 59, 121, 120, 108, 112, 120, 65, 89, 68, 24, 103, 113, 51, 98, 127, 123, 112, 120}, "14a668", false, true));
        }
        this.orientation = i;
    }
}
