...
class ClockFaceView extends RadialViewGroup implements ClockHandView.OnRotateListener {
    ...
    private static final String VALUE_PLACEHOLDER = NPStringFog.decode(new byte[0], "562adf", 285940545L);
    ...
    public ClockFaceView(Context context, AttributeSet attributeSet, int i) {
        ...
        getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener(this) { // from class: com.google.android.material.timepicker.ClockFaceView.1
            ...
            public boolean onPreDraw() {
                if (this.this$0.isShown()) {
                    ...
                    int selectorRadius = this.this$0.clockHandView.getSelectorRadius();
                    this.this$0.setRadius((height - selectorRadius) - this.this$0.clockHandPadding);
                }
                return true;
            }
        });
        ...
        this.valueAccessibilityDelegate = new AccessibilityDelegateCompat(this) { // from class: com.google.android.material.timepicker.ClockFaceView.2
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (iIntValue > 0) {
                    accessibilityNodeInfoCompat.setTraversalAfter((View) this.this$0.textViewPool.get(iIntValue - 1));
                }
            ...
            public boolean performAccessibilityAction(View view, int i2, Bundle bundle) {
                ...
                this.this$0.clockHandView.onTouchEvent(MotionEvent.obtain(jUptimeMillis, jUptimeMillis, 0, x, y, 0));
                this.this$0.clockHandView.onTouchEvent(MotionEvent.obtain(jUptimeMillis, jUptimeMillis, 1, x, y, 0));
                return true;
            }
        };
    ...
    private RadialGradient getGradientForTextView(RectF rectF, Rect rect, TextView textView) {
        ...
        if (RectF.intersects(rectF, this.scratch)) {
            return new RadialGradient(rectF.centerX() - this.scratch.left, rectF.centerY() - this.scratch.top, 0.5f * rectF.width(), this.gradientColors, this.gradientPositions, Shader.TileMode.CLAMP);
        }
        return null;
    }
