...
class TimeModel implements Parcelable {
    ...
    int period;
    int selection;
    public static final String NUMBER_FORMAT = NPStringFog.decode(new byte[]{68, 87}, "a3abba", 6.252149E8f);
    public static final String ZERO_LEADING_NUMBER_FORMAT = NPStringFog.decode(new byte[]{64, 7, 0, 86}, "e722b8", 1.0977139E9f);
    ...
    public void setHour(int i) {
        if (this.format == 1) {
            ...
            this.hour = (this.period == 1 ? 12 : 0) + (i % 12);
        }
    }
