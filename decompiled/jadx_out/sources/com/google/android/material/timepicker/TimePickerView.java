...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    static final String GENERIC_VIEW_ACCESSIBILITY_CLASS_NAME = NPStringFog.decode(new byte[]{81, 86, 86, 20, 90, 11, 84, 22, 68, 15, 80, 21, 30, 110, 91, 3, 66}, "082f5b", -1.610678398E9d);
    ...
    public TimePickerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.selectionListener = new View.OnClickListener(this) { // from class: com.google.android.material.timepicker.TimePickerView.1
            ...
            public void onClick(View view) {
                if (this.this$0.onSelectionChangeListener != null) {
                    this.this$0.onSelectionChangeListener.onSelectionChanged(((Integer) view.getTag(R.id.selection_type)).intValue());
                }
            }
        };
        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener(this) { // from class: com.google.android.material.timepicker.TimePickerView.2
            ...
            public void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup2, int i2, boolean z) {
                ...
                if (this.this$0.onPeriodChangeListener == null || !z) {
                    return;
                }
                this.this$0.onPeriodChangeListener.onPeriodChange(i3);
            }
        });
    ...
    private void setupDoubleTap() {
        View.OnTouchListener onTouchListener = new View.OnTouchListener(this, new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener(this) { // from class: com.google.android.material.timepicker.TimePickerView.3
            final TimePickerView this$0;
            ...
            public boolean onDoubleTap(MotionEvent motionEvent) {
                OnDoubleTapListener onDoubleTapListener = this.this$0.onDoubleTapListener;
        ...
        })) { // from class: com.google.android.material.timepicker.TimePickerView.4
            final TimePickerView this$0;
    ...
    public void updateTime(int i, int i2, int i3) {
        ...
        String str = String.format(locale, NPStringFog.decode(new byte[]{19, 4, 86, 82}, "64d638", -8.86109896E8d), Integer.valueOf(i3));
        String str2 = String.format(locale, NPStringFog.decode(new byte[]{65, 3, 87, 81}, "d3e59f", 32518), Integer.valueOf(i2));
