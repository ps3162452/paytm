...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    private static final String ACCESSIBILITY_CLASS_NAME = NPStringFog.decode(new byte[]{84, 94, 80, 69, 95, 90, 81, 72, 26, 84, 81, 65, 81, 70, 93, 82, 71, 29, 66, 89, 80, 80, 85, 71, 27, 115, 85, 69, 84, 101, 92, 85, 67}, "504703", true);
    private static final String LOG_TAG = NPStringFog.decode(new byte[]{46, 2, 21, 83, 65, 11, 2, 15, 34, 87, 65, 6, 53, 10, 4, 65}, "cca63b", -1019966663L);
    ...
    public void setBackgroundDrawable(Drawable drawable) {
        if (this.isParentCardViewDoneInitializing) {
            if (!this.cardViewHelper.isBackgroundOverwritten()) {
                Log.i(LOG_TAG, NPStringFog.decode(new byte[]{50, 80, 64, 17, 95, 86, 6, 21, 85, 69, 85, 77, 18, 65, 91, 8, 22, 90, 0, 86, 95, 2, 68, 87, 20, 91, 80, 69, 95, 75, 65, 91, 91, 17, 22, 75, 20, 69, 68, 10, 68, 76, 4, 81, 26}, "a54e68", false));
