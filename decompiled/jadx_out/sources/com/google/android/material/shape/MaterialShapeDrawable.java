...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    private MaterialShapeDrawable(MaterialShapeDrawableState materialShapeDrawableState) {
        ...
        this.pathShadowListener = new ShapeAppearancePathProvider.PathListener(this) { // from class: com.google.android.material.shape.MaterialShapeDrawable.1
            ...
            public void onCornerPathCreated(ShapePath shapePath, Matrix matrix, int i) {
                this.this$0.containsIncompatibleShadowOp.set(i, shapePath.containsIncompatibleShadowOp());
            ...
            public void onEdgePathCreated(ShapePath shapePath, Matrix matrix, int i) {
                this.this$0.containsIncompatibleShadowOp.set(i + 4, shapePath.containsIncompatibleShadowOp());
    ...
    private void calculateStrokePath() {
        ShapeAppearanceModel shapeAppearanceModelWithTransformedCornerSizes = getShapeAppearanceModel().withTransformedCornerSizes(new ShapeAppearanceModel.CornerSizeUnaryOperator(this, -getStrokeInsetLength()) { // from class: com.google.android.material.shape.MaterialShapeDrawable.2
            final MaterialShapeDrawable this$0;
    ...
    private void drawCompatShadow(Canvas canvas) {
        if (this.containsIncompatibleShadowOp.cardinality() > 0) {
            Log.w(TAG, NPStringFog.decode(new byte[]{115, 92, 91, 73, 80, 69, 89, 81, 95, 85, 88, 69, 73, 19, 69, 81, 80, 85, 95, 68, 22, 75, 84, 64, 69, 86, 69, 77, 84, 85, 16, 81, 67, 77, 17, 82, 81, 93, 17, 77, 17, 83, 85, 19, 82, 75, 80, 70, 94, 19, 80, 86, 67, 17, 81, 95, 90, 25, 94, 65, 85, 65, 87, 77, 88, 94, 94, 64, 22, 80, 95, 17, 68, 91, 95, 74, 17, 66, 88, 82, 70, 92, 31}, "036911", -786996236L));
        }
    ...
    private void maybeDrawCompatShadow(Canvas canvas) {
        if (hasCompatShadow()) {
            ...
            if (iWidth < 0 || iHeight < 0) {
                throw new IllegalStateException(NPStringFog.decode(new byte[]{43, 8, 16, 7, 15, 88, 6, 70, 21, 14, 2, 85, 13, 17, 70, 4, 12, 68, 12, 2, 21, 72, 67, 114, 10, 3, 5, 13, 67, 69, 10, 7, 18, 70, 23, 89, 7, 70, 18, 20, 6, 80, 22, 11, 3, 8, 23, 66, 66, 20, 3, 21, 22, 93, 22, 70, 15, 8, 67, 80, 66, 16, 7, 10, 10, 85, 66, 22, 7, 18, 11, 31}, "bfffc1", false));
            }
