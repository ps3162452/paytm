...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    private Animator createElevationAnimator(float f, float f2) {
        ...
        animatorSet.play(ObjectAnimator.ofFloat(this.view, NPStringFog.decode(new byte[]{85, 8, 80, 66, 84, 17, 89, 11, 91}, "0d545e", -1.934451622E9d), f).setDuration(0L)).with(ObjectAnimator.ofFloat(this.view, (Property<FloatingActionButton, Float>) View.TRANSLATION_Z, f2).setDuration(100L));
    ...
    void onElevationsChanged(float f, float f2, float f3) {
        if (Build.VERSION.SDK_INT == 21) {
            ...
            arrayList.add(ObjectAnimator.ofFloat(this.view, NPStringFog.decode(new byte[]{7, 10, 86, 71, 84, 69, 11, 9, 93}, "bf3151", true, true), f).setDuration(0L));
