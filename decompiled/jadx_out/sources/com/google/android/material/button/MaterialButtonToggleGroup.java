...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        this.childOrderComparator = new Comparator<MaterialButton>(this) { // from class: com.google.android.material.button.MaterialButtonToggleGroup.1
            ...
            public int compare(MaterialButton materialButton, MaterialButton materialButton2) {
                ...
                return iCompareTo2 == 0 ? Integer.valueOf(this.this$0.indexOfChild(materialButton)).compareTo(Integer.valueOf(this.this$0.indexOfChild(materialButton2))) : iCompareTo2;
            }
        };
    ...
    private void checkInternal(int i, boolean z) {
        if (i == -1) {
            Log.e(LOG_TAG, NPStringFog.decode(new byte[]{115, 69, 23, 71, 95, 12, 17, 121, 39, 19, 89, 17, 17, 94, 12, 71, 16, 20, 80, 92, 10, 87, 10, 66}, "10c30b", 1.0852389E9f) + i);
            return;
        }
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        if (!(view instanceof MaterialButton)) {
            Log.e(LOG_TAG, NPStringFog.decode(new byte[]{114, 80, 94, 90, 7, 17, 71, 81, 82, 65, 16, 17, 92, 77, 68, 66, 67, 83, 84, 24, 88, 80, 67, 69, 72, 72, 82, 22, 46, 80, 69, 93, 69, 95, 2, 93, 115, 77, 67, 66, 12, 95, 31}, "1876c1", -957698381L));
            return;
        }
    ...
    protected int getChildDrawingOrder(int i, int i2) {
        ...
        Log.w(LOG_TAG, NPStringFog.decode(new byte[]{114, 95, 92, 15, 85, 68, 94, 69, 81, 6, 67, 68, 70, 86, 70, 13, 22, 16, 17, 66, 69, 7, 80, 16, 84, 83}, "175c1d", -10768));
        return i2;
    }
