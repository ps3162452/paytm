...
public class NavigationRailView extends NavigationBarView {
    ...
    private void applyWindowInsets() {
        ViewUtils.doOnApplyWindowInsets(this, new ViewUtils.OnApplyWindowInsetsListener(this) { // from class: com.google.android.material.navigationrail.NavigationRailView.1
            final NavigationRailView this$0;
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat, ViewUtils.RelativePadding relativePadding) {
                ...
                relativePadding.start = (z ? windowInsetsCompat.getSystemWindowInsetRight() : systemWindowInsetLeft) + relativePadding.start;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (i5 > 0) {
            navigationRailMenuView.layout(navigationRailMenuView.getLeft(), navigationRailMenuView.getTop() + i5, navigationRailMenuView.getRight(), i5 + navigationRailMenuView.getBottom());
        }
    }
