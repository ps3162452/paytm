...
public class MaterialResources {
    ...
    public static int getUnscaledTextSize(Context context, int i, int i2) {
        ...
        typedArrayObtainStyledAttributes.recycle();
        return value ? getComplexUnit(typedValue) == 2 ? Math.round(TypedValue.complexToFloat(typedValue.data) * context.getResources().getDisplayMetrics().density) : TypedValue.complexToDimensionPixelSize(typedValue.data, context.getResources().getDisplayMetrics()) : i2;
    }
