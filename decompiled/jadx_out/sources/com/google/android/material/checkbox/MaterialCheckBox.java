...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int width = (ViewUtils.isLayoutRtl(this) ? -1 : 1) * ((getWidth() - buttonDrawable.getIntrinsicWidth()) / 2);
        ...
        if (getBackground() != null) {
            ...
            DrawableCompat.setHotspotBounds(getBackground(), bounds.left + width, bounds.top, width + bounds.right, bounds.bottom);
        }
    }
