...
public final class CollapsingTextHelper {
    ...
    private static final String ELLIPSIS_NORMAL = NPStringFog.decode(new byte[]{-37, -29, -108}, "9c2c01", 6.2294995E8f);
    private static final String TAG = NPStringFog.decode(new byte[]{32, 88, 9, 93, 88, 71, 16, 94, 11, 86, 109, 82, 27, 67, 45, 84, 85, 71, 6, 69}, "c7e197", true, true);
    ...
    private void calculateOffsets(float f) {
        ...
        if (this.fadeModeEnabled) {
            this.textPaint.setAlpha((int) (this.textPaint.getAlpha() * calculateFadeModeTextAlpha(f)));
        }
    ...
    private void calculateUsingTextSize(float f, boolean z) {
        ...
        if (isClose(f, 1.0f)) {
            ...
            if (z) {
                ...
                if (fWidth2 * f9 > fWidth) {
                    fWidth2 = Math.min(fWidth / f9, fWidth2);
                }
                f2 = f7;
                f3 = fWidth2;
                f4 = f8;
        ...
        if (f3 > 0.0f) {
            z4 = ((this.currentTextSize > f2 ? 1 : (this.currentTextSize == f2 ? 0 : -1)) != 0) || ((this.currentLetterSpacing > f4 ? 1 : (this.currentLetterSpacing == f4 ? 0 : -1)) != 0) || this.boundsChanged || z3;
        ...
        if (this.textToDraw == null || z4) {
            ...
            StaticLayout staticLayoutCreateStaticLayout = createStaticLayout(shouldDrawMultiline() ? this.maxLines : 1, f3, this.isRtl);
    ...
    private void drawMultilineTransition(Canvas canvas, float f, float f2) {
        ...
        canvas.drawText(strTrim, 0, Math.min(this.textLayout.getLineEnd(0), strTrim.length()), 0.0f, lineBaseline, (Paint) this.textPaint);
    }
