...
abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable2Compat {
    ...
    private void setHideAnimator(ValueAnimator valueAnimator) {
        ...
        if (valueAnimator2 != null && valueAnimator2.isRunning()) {
            throw new IllegalArgumentException(NPStringFog.decode(new byte[]{39, 88, 89, 86, 88, 77, 68, 74, 82, 76, 23, 81, 13, 93, 82, 121, 89, 80, 9, 88, 67, 87, 69, 25, 19, 81, 94, 84, 82, 25, 16, 81, 82, 24, 84, 76, 22, 75, 82, 86, 67, 25, 12, 80, 83, 93, 118, 87, 13, 84, 86, 76, 88, 75, 68, 80, 68, 24, 69, 76, 10, 87, 94, 86, 80, 23}, "d97879", false, false));
        }
        this.hideAnimator = valueAnimator;
        valueAnimator.addListener(new AnimatorListenerAdapter(this) { // from class: com.google.android.material.progressindicator.DrawableWithAnimatedVisibilityChange.2
    ...
    private void setShowAnimator(ValueAnimator valueAnimator) {
        ...
        if (valueAnimator2 != null && valueAnimator2.isRunning()) {
            throw new IllegalArgumentException(NPStringFog.decode(new byte[]{39, 88, 11, 8, 87, 69, 68, 74, 0, 18, 24, 66, 12, 86, 18, 39, 86, 88, 9, 88, 17, 9, 74, 17, 19, 81, 12, 10, 93, 17, 16, 81, 0, 70, 91, 68, 22, 75, 0, 8, 76, 17, 23, 81, 10, 17, 121, 95, 13, 84, 4, 18, 87, 67, 68, 80, 22, 70, 74, 68, 10, 87, 12, 8, 95, 31}, "d9ef81", true, false));
        }
        this.showAnimator = valueAnimator;
        valueAnimator.addListener(new AnimatorListenerAdapter(this) { // from class: com.google.android.material.progressindicator.DrawableWithAnimatedVisibilityChange.1
            final DrawableWithAnimatedVisibilityChange this$0;
