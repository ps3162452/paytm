...
final class CircularIndeterminateAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private static final Property<CircularIndeterminateAnimatorDelegate, Float> ANIMATION_FRACTION = new Property<CircularIndeterminateAnimatorDelegate, Float>(Float.class, NPStringFog.decode(new byte[]{85, 88, 92, 9, 87, 66, 93, 89, 91, 34, 68, 87, 87, 66, 92, 11, 88}, "465d66", -1.6169349E9f)) { // from class: com.google.android.material.progressindicator.CircularIndeterminateAnimatorDelegate.3
    ...
    private static final Property<CircularIndeterminateAnimatorDelegate, Float> COMPLETE_END_FRACTION = new Property<CircularIndeterminateAnimatorDelegate, Float>(Float.class, NPStringFog.decode(new byte[]{5, 87, 90, 64, 15, 86, 18, 93, 114, 94, 7, 117, 20, 89, 84, 68, 10, 92, 8}, "f870c3", true)) { // from class: com.google.android.material.progressindicator.CircularIndeterminateAnimatorDelegate.4
        @Override // android.util.Property
        public Float get(CircularIndeterminateAnimatorDelegate circularIndeterminateAnimatorDelegate) {
    ...
    private void maybeInitializeAnimators() {
        if (this.animator == null) {
            ...
            this.animator.addListener(new AnimatorListenerAdapter(this) { // from class: com.google.android.material.progressindicator.CircularIndeterminateAnimatorDelegate.1
                ...
                public void onAnimationRepeat(Animator animator) {
                    ...
                    circularIndeterminateAnimatorDelegate.indicatorColorIndexOffset = (circularIndeterminateAnimatorDelegate.indicatorColorIndexOffset + 4) % this.this$0.baseSpec.indicatorColors.length;
                }
            });
        }
        if (this.completeEndAnimator == null) {
            ...
            this.completeEndAnimator.addListener(new AnimatorListenerAdapter(this) { // from class: com.google.android.material.progressindicator.CircularIndeterminateAnimatorDelegate.2
                final CircularIndeterminateAnimatorDelegate this$0;
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    if (this.this$0.animatorCompleteCallback != null) {
                        this.this$0.animatorCompleteCallback.onAnimationEnd(this.this$0.drawable);
                    }
                }
            });
        }
    ...
    private void updateSegmentPositions(int i) {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            ...
            fArr[1] = (this.interpolator.getInterpolation(fractionInRange) * 250.0f) + fArr[1];
            float fractionInRange2 = getFractionInRange(i, DELAY_TO_COLLAPSE_IN_MS[i2], 667);
            float[] fArr2 = this.segmentPositions;
            fArr2[0] = (this.interpolator.getInterpolation(fractionInRange2) * 250.0f) + fArr2[0];
        }
