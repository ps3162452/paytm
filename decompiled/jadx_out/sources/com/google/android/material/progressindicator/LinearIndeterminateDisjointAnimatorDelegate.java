...
final class LinearIndeterminateDisjointAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private void maybeInitializeAnimators() {
        if (this.animator == null) {
            ...
            this.animator.addListener(new AnimatorListenerAdapter(this) { // from class: com.google.android.material.progressindicator.LinearIndeterminateDisjointAnimatorDelegate.1
                ...
                public void onAnimationRepeat(Animator animator) {
                    ...
                    linearIndeterminateDisjointAnimatorDelegate.indicatorColorIndex = (linearIndeterminateDisjointAnimatorDelegate.indicatorColorIndex + 1) % this.this$0.baseSpec.indicatorColors.length;
        ...
        if (this.completeEndAnimator == null) {
            ...
            this.completeEndAnimator.addListener(new AnimatorListenerAdapter(this) { // from class: com.google.android.material.progressindicator.LinearIndeterminateDisjointAnimatorDelegate.2
                final LinearIndeterminateDisjointAnimatorDelegate this$0;
    ...
    void setAnimationFraction(float f) {
        ...
        updateSegmentPositions((int) (1800.0f * f));
