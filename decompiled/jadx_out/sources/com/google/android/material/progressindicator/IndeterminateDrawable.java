    ...
    public void draw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (i2 >= this.animatorDelegate.segmentColors.length) {
                ...
                this.drawingDelegate.fillIndicator(canvas, this.paint, this.animatorDelegate.segmentPositions[i2 * 2], this.animatorDelegate.segmentPositions[(i2 * 2) + 1], this.animatorDelegate.segmentColors[i2]);
                i = i2 + 1;
            }
        }
    }
