...
public final class ScaleProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createScaleAnimator(View view, float f, float f2) {
        ...
        objectAnimatorOfPropertyValuesHolder.addListener(new AnimatorListenerAdapter(view, scaleX, scaleY) { // from class: com.google.android.material.transition.ScaleProvider.1
