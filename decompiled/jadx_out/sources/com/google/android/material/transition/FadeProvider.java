...
public final class FadeProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createFadeAnimator(View view, float f, float f2, float f3, float f4, float f5) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(view, f, f2, f3, f4) { // from class: com.google.android.material.transition.FadeProvider.1
        ...
        valueAnimatorOfFloat.addListener(new AnimatorListenerAdapter(view, f5) { // from class: com.google.android.material.transition.FadeProvider.2
