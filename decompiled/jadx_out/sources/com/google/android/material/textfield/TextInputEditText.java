...
public class TextInputEditText extends AppCompatEditText {
    ...
    private String getAccessibilityNodeInfoText(TextInputLayout textInputLayout) {
        ...
        if (!zIsEmpty) {
            return ((Object) text) + (TextUtils.isEmpty(string) ? "" : NPStringFog.decode(new byte[]{77, 21}, "a50272", -1921781583L) + string);
        }
    ...
    public boolean requestRectangleOnScreen(Rect rect) {
        ...
        this.parentRect.set(rect.left, rect.top, rect.right, (textInputLayout.getHeight() - getHeight()) + rect.bottom);
