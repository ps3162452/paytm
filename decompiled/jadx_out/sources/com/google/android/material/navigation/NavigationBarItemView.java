...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
        ...
        if (imageView != null) {
            imageView.addOnLayoutChangeListener(new View.OnLayoutChangeListener(this) { // from class: com.google.android.material.navigation.NavigationBarItemView.1
                ...
                public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                    if (this.this$0.icon.getVisibility() == 0) {
    ...
    private int getSuggestedIconWidth() {
        ...
        return Math.max(minimumWidth, layoutParams.rightMargin) + Math.max(minimumWidth, layoutParams.leftMargin) + this.icon.getMeasuredWidth();
    }
    ...
    private void maybeAnimateActiveIndicatorToProgress(float f) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this, f) { // from class: com.google.android.material.navigation.NavigationBarItemView.3
            final NavigationBarItemView this$0;
            final float val$newProgress;
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.this$0.setActiveIndicatorProgress(((Float) valueAnimator2.getAnimatedValue()).floatValue(), this.val$newProgress);
            }
        });
    ...
    protected int getSuggestedMinimumHeight() {
        ...
        return layoutParams.bottomMargin + getSuggestedIconHeight() + layoutParams.topMargin + this.labelGroup.getMeasuredHeight();
    }
    ...
    protected int getSuggestedMinimumWidth() {
        ...
        return Math.max(getSuggestedIconWidth(), layoutParams.rightMargin + i + measuredWidth);
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (badgeDrawable != null && badgeDrawable.isVisible()) {
            ...
            accessibilityNodeInfo.setContentDescription(((Object) title) + NPStringFog.decode(new byte[]{77, 17}, "a1815a", 18314) + ((Object) this.badgeDrawable.getContentDescription()));
        }
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        post(new Runnable(this, i) { // from class: com.google.android.material.navigation.NavigationBarItemView.2
            final NavigationBarItemView this$0;
            final int val$width;
    ...
    void setBadge(BadgeDrawable badgeDrawable) {
        ...
        if (hasBadge() && this.icon != null) {
            Log.w(NPStringFog.decode(new byte[]{119, 81, 66, 95, 85, 0, 77, 89, 91, 88, 112, 0, 75}, "90462a", 1763527292L), NPStringFog.decode(new byte[]{117, 70, 8, 66, 94, 18, 84, 86, 68, 84, 86, 6, 95, 86, 23, 22, 68, 10, 87, 70, 8, 82, 89, 69, 76, 19, 6, 83, 23, 3, 76, 71, 5, 85, 95, 7, 92, 19, 16, 89, 23, 13, 86, 86, 68, 95, 67, 7, 85, 29}, "83d67b", 1451268959L));
            tryRemoveBadgeFromAnchor(this.icon);
        }
