...
public abstract class NavigationBarMenuView extends ViewGroup implements MenuView {
    ...
    private void validateMenuItemId(int i) {
        if (!isValidId(i)) {
            throw new IllegalArgumentException(i + NPStringFog.decode(new byte[]{20, 13, 70, 67, 8, 11, 64, 68, 84, 67, 16, 5, 88, 13, 81, 67, 16, 13, 81, 19, 21, 10, 2}, "4d5cfd", -1.450082834E9d));
        }
    }
