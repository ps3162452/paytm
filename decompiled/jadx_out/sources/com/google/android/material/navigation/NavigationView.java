...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        navigationMenu.setCallback(new MenuBuilder.Callback(this) { // from class: com.google.android.material.navigation.NavigationView.1
    ...
    private void setupInsetScrimsListener() {
        this.onGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener(this) { // from class: com.google.android.material.navigation.NavigationView.2
            ...
            public void onGlobalLayout() {
                ...
                boolean z = this.this$0.tmpLocation[1] == 0;
                ...
                boolean z2 = activity.findViewById(R.id.content).getHeight() == this.this$0.getHeight();
    ...
    public void setCheckedItem(MenuItem menuItem) {
        ...
        if (menuItemFindItem == null) {
            throw new IllegalArgumentException(NPStringFog.decode(new byte[]{112, 89, 89, 85, 84, 6, 19, 75, 80, 77, 114, 10, 86, 91, 94, 92, 85, 43, 71, 93, 88, 17, 124, 7, 93, 77, 124, 77, 84, 15, 26, 24, 66, 80, 69, 10, 19, 89, 91, 25, 88, 22, 86, 85, 21, 77, 89, 3, 71, 24, 92, 74, 17, 12, 92, 76, 21, 80, 95, 66, 71, 80, 80, 25, 82, 23, 65, 74, 80, 87, 69, 66, 94, 93, 91, 76, 31}, "38591b", -3.2012355E8f));
        }
        this.presenter.setCheckedItem((MenuItemImpl) menuItemFindItem);
    }
