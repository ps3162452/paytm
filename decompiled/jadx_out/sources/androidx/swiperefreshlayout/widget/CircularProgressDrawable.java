...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private void setupAnimators() {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this, ring) { // from class: androidx.swiperefreshlayout.widget.CircularProgressDrawable.1
        ...
        valueAnimatorOfFloat.addListener(new Animator.AnimatorListener(this, ring) { // from class: androidx.swiperefreshlayout.widget.CircularProgressDrawable.2
            final CircularProgressDrawable this$0;
            final Ring val$ring;
    ...
    void applyTransformation(float f, Ring ring, boolean z) {
        ...
        if (f != 1.0f || z) {
            ...
            setRotation(GROUP_FULL_ROTATION * (f + f2));
        }
    }
