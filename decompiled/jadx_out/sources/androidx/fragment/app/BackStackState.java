...
final class BackStackState implements Parcelable {
    ...
    private static final String TAG = NPStringFog.decode(new byte[]{116, 67, 89, 4, 84, 1, 92, 69, 117, 2, 87, 5, 85, 84, 74}, "218c9d", -26132);
    ...
    public BackStackState(BackStackRecord backStackRecord) {
        ...
        if (!backStackRecord.mAddToBackStack) {
            throw new IllegalStateException(NPStringFog.decode(new byte[]{45, 92, 17, 65, 11, 11, 67, 81, 4, 2, 15, 69, 16, 71, 4, 2, 15}, "c3eade", 22966));
        }
    ...
    public BackStackRecord instantiate(FragmentManager fragmentManager) {
        ...
        while (i < this.mOps.length) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v(TAG, NPStringFog.decode(new byte[]{44, 95, 22, 18, 3, 91, 17, 88, 4, 18, 7, 21}, "e1efb5", -2.0763048E9f) + backStackRecord + NPStringFog.decode(new byte[]{66, 91, 65, 23, 70}, "b417e9", -382) + i2 + NPStringFog.decode(new byte[]{69, 82, 81, 16, 4, 21, 3, 66, 81, 4, 12, 80, 11, 68, 16, 64}, "e00ca5", true) + this.mOps[i3]);
            }
