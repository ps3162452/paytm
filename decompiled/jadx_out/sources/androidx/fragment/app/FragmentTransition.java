...
class FragmentTransition {
    ...
    private static void addToFirstInLastOut(BackStackRecord backStackRecord, FragmentTransaction.Op op, SparseArray<FragmentContainerTransition> sparseArray, boolean z, boolean z2) {
        ...
        switch (z ? INVERSE_OPS[op.mCmd] : op.mCmd) {
            case 1:
            case 7:
                z3 = false;
                z4 = false;
        ...
        if (z3 && (fragmentContainerTransitionEnsureContainer == null || fragmentContainerTransitionEnsureContainer.firstOut == null)) {
            fragmentContainerTransitionEnsureContainer = ensureContainer(fragmentContainerTransitionEnsureContainer, sparseArray, i);
    ...
    private static FragmentTransitionImpl chooseImpl(Fragment fragment, Fragment fragment2) {
        ...
        throw new IllegalArgumentException(NPStringFog.decode(new byte[]{125, 92, 70, 82, 93, 95, 80, 18, 100, 65, 80, 88, 71, 91, 68, 90, 94, 88, 20, 70, 73, 67, 84, 69}, "420316", 8.30568419E8d));
    }
    ...
    private static Object configureSharedElementsReordered(FragmentTransitionImpl fragmentTransitionImpl, ViewGroup viewGroup, View view, ArrayMap<String, String> arrayMap, FragmentContainerTransition fragmentContainerTransition, ArrayList<View> arrayList, ArrayList<View> arrayList2, Object obj, Object obj2) {
        ...
        OneShotPreDrawListener.add(viewGroup, new Runnable(fragment, fragment2, z, arrayMapCaptureInSharedElements, inEpicenterView, fragmentTransitionImpl, rect) { // from class: androidx.fragment.app.FragmentTransition.5
    ...
    private static void configureTransitionsOrdered(ViewGroup viewGroup, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap<String, String> arrayMap, Callback callback) {
        ...
        if (fragment2 != null && arrayListConfigureEnteringExitingViews != null && (arrayListConfigureEnteringExitingViews.size() > 0 || arrayList.size() > 0)) {
            ...
            fragmentTransitionImplChooseImpl.setListenerForTransitionEnd(fragment2, objMergeTransitions, cancellationSignal, new Runnable(callback, fragment2, cancellationSignal) { // from class: androidx.fragment.app.FragmentTransition.3
    ...
    private static void configureTransitionsReordered(ViewGroup viewGroup, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap<String, String> arrayMap, Callback callback) {
        ...
        if (fragment2 != null && arrayListConfigureEnteringExitingViews != null && (arrayListConfigureEnteringExitingViews.size() > 0 || arrayList2.size() > 0)) {
            CancellationSignal cancellationSignal = new CancellationSignal();
            callback.onStart(fragment2, cancellationSignal);
            fragmentTransitionImplChooseImpl.setListenerForTransitionEnd(fragment2, objMergeTransitions, cancellationSignal, new Runnable(callback, fragment2, cancellationSignal) { // from class: androidx.fragment.app.FragmentTransition.1
                final Callback val$callback;
                final Fragment val$outFragment;
                final CancellationSignal val$signal;
    ...
    private static FragmentTransitionImpl resolveSupportImpl() {
        try {
            return (FragmentTransitionImpl) Class.forName(NPStringFog.decode(new byte[]{87, 8, 82, 67, 90, 80, 82, 30, 24, 69, 71, 88, 88, 21, 95, 69, 92, 86, 88, 72, 112, 67, 84, 94, 91, 3, 88, 69, 97, 75, 87, 8, 69, 88, 65, 80, 89, 8, 101, 68, 69, 73, 89, 20, 66}, "6f6159", 5.7212416E8f)).getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
        } catch (Exception e) {
            return null;
        }
    }
