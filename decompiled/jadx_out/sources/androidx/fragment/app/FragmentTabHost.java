...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return NPStringFog.decode(new byte[]{112, 65, 83, 82, 95, 92, 88, 71, 102, 84, 80, 113, 89, 64, 70, 27, 97, 88, 64, 86, 86, 102, 70, 88, 66, 86, 73}, "632529", 1.158729321E9d) + Integer.toHexString(System.identityHashCode(this)) + NPStringFog.decode(new byte[]{21, 82, 64, 74, 50, 7, 87, 12}, "5158ff", false, true) + this.curTab + NPStringFog.decode(new byte[]{31}, "b88808", true);
        }
    ...
    private void ensureContent() {
        if (this.mRealTabContent == null) {
            ...
            throw new IllegalStateException(NPStringFog.decode(new byte[]{125, 87, 16, 67, 5, 7, 19, 91, 95, 89, 16, 0, 93, 76, 16, 113, 22, 4, 94, 93, 124, 86, 29, 10, 70, 76, 16, 81, 11, 16, 93, 92, 16, 81, 11, 23, 19, 81, 84, 23}, "3807de", -1.07829043E9d) + this.mContainerId);
        }
    }
    ...
    @Deprecated
    public void setup() {
        throw new IllegalStateException(NPStringFog.decode(new byte[]{116, 19, 21, 67, 16, 80, 88, 10, 10, 23, 67, 86, 77, 19, 22, 31, 25, 19, 77, 14, 7, 67, 16, 71, 88, 13, 3, 68, 16, 82, 25, 37, 9, 89, 68, 86, 65, 18, 70, 86, 94, 87, 25, 32, 20, 86, 87, 94, 92, 8, 18, 122, 81, 93, 88, 1, 3, 69}, "9ff703", false));
    }
