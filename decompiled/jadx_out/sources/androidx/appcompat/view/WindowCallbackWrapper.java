...
public class WindowCallbackWrapper implements Window.Callback {
    ...
    public WindowCallbackWrapper(Window.Callback callback) {
        if (callback == null) {
            throw new IllegalArgumentException(NPStringFog.decode(new byte[]{100, 15, 95, 7, 11, 17, 19, 5, 80, 15, 8, 4, 82, 5, 90, 67, 9, 7, 74, 70, 95, 12, 16, 70, 81, 3, 17, 13, 17, 10, 95}, "3f1cdf", false));
        }
