...
public class MenuWrapperICS extends BaseMenuWrapper implements Menu {
    ...
    public MenuWrapperICS(Context context, SupportMenu supportMenu) {
        super(context);
        if (supportMenu == null) {
            throw new IllegalArgumentException(NPStringFog.decode(new byte[]{110, 66, 87, 68, 73, 92, 93, 16, 121, 86, 83, 92, 90, 68, 22, 87, 88, 87, 25, 94, 89, 64, 25, 91, 92, 16, 88, 65, 85, 85, 23}, "906499", -4.9815E8f));
        }
