...
final class StandardMenuPopup extends MenuPopup implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener, MenuPresenter, View.OnKeyListener {
    ...
    final ViewTreeObserver.OnGlobalLayoutListener mGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener(this) { // from class: androidx.appcompat.view.menu.StandardMenuPopup.1
    ...
    private final View.OnAttachStateChangeListener mAttachStateChangeListener = new View.OnAttachStateChangeListener(this) { // from class: androidx.appcompat.view.menu.StandardMenuPopup.2
        final StandardMenuPopup this$0;
    ...
    public void show() {
        if (!tryShow()) {
            throw new IllegalStateException(NPStringFog.decode(new byte[]{48, 16, 87, 95, 7, 86, 17, 0, 123, 84, 13, 66, 51, 11, 70, 68, 19, 23, 0, 5, 88, 95, 12, 67, 67, 6, 83, 17, 22, 68, 6, 0, 22, 70, 10, 67, 11, 11, 67, 69, 67, 86, 13, 68, 87, 95, 0, 95, 12, 22}, "cd61c7", -29794));
        }
    }
