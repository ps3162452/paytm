...
public abstract class ActionBar {
    ...
    public void setElevation(float f) {
        if (f != 0.0f) {
            throw new UnsupportedOperationException(NPStringFog.decode(new byte[]{97, 80, 67, 17, 10, 12, 85, 21, 86, 69, 13, 13, 92, 24, 77, 0, 17, 13, 18, 80, 91, 0, 21, 3, 70, 92, 88, 11, 67, 11, 65, 21, 89, 10, 23, 66, 65, 64, 71, 21, 12, 16, 70, 80, 83, 69, 10, 12, 18, 65, 95, 12, 16, 66, 83, 86, 67, 12, 12, 12, 18, 87, 86, 23, 67, 1, 93, 91, 81, 12, 4, 23, 64, 84, 67, 12, 12, 12, 28}, "257ecb", -566977461L));
        }
    }

    public void setHideOffset(int i) {
        if (i != 0) {
            throw new UnsupportedOperationException(NPStringFog.decode(new byte[]{53, 1, 67, 69, 91, 91, 1, 68, 86, 95, 18, 80, 30, 20, 91, 88, 81, 92, 18, 68, 86, 82, 70, 92, 9, 10, 23, 83, 83, 71, 70, 12, 94, 85, 87, 21, 9, 2, 81, 66, 87, 65, 70, 13, 68, 17, 92, 90, 18, 68, 68, 68, 66, 69, 9, 22, 67, 84, 86, 21, 15, 10, 23, 69, 90, 92, 21, 68, 86, 82, 70, 92, 9, 10, 23, 83, 83, 71, 70, 7, 88, 95, 84, 92, 1, 17, 69, 80, 70, 92, 9, 10, 25}, "fd7125", -1257));
        }
    }

    public void setHideOnContentScrollEnabled(boolean z) {
        if (z) {
            throw new UnsupportedOperationException(NPStringFog.decode(new byte[]{123, 80, 84, 93, 18, 94, 93, 25, 83, 87, 92, 69, 86, 87, 68, 24, 65, 82, 65, 86, 92, 84, 18, 88, 64, 25, 94, 87, 70, 17, 64, 76, 64, 72, 93, 67, 71, 92, 84, 24, 91, 95, 19, 77, 88, 81, 65, 17, 82, 90, 68, 81, 93, 95, 19, 91, 81, 74, 18, 82, 92, 87, 86, 81, 85, 68, 65, 88, 68, 81, 93, 95, 29}, "390821", -9.03058516E8d));
        }
    }
