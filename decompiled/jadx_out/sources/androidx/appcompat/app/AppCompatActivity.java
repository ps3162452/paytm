...
public class AppCompatActivity extends FragmentActivity implements AppCompatCallback, TaskStackBuilder.SupportParentable, ActionBarDrawerToggle.DelegateProvider {
    private static final String DELEGATE_TAG = NPStringFog.decode(new byte[]{81, 86, 0, 22, 14, 13, 84, 64, 94, 5, 17, 20, 83, 87, 9, 20, 0, 16}, "08ddad", -21968);
    ...
    private void initDelegate() {
        ...
        addOnContextAvailableListener(new OnContextAvailableListener(this) { // from class: androidx.appcompat.app.AppCompatActivity.2
            ...
            public void onContextAvailable(Context context) {
                ...
                delegate.onCreate(this.this$0.getSavedStateRegistry().consumeRestoredStateForKey(NPStringFog.decode(new byte[]{83, 13, 82, 70, 91, 95, 86, 27, 12, 85, 68, 70, 81, 12, 91, 68, 85, 66}, "2c6446", -1.457093813E9d)));
            }
        });
    }
