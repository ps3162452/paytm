...
public abstract class AppCompatDelegate {
    ...
    static final String TAG = NPStringFog.decode(new byte[]{114, 65, 19, 112, 9, 95, 67, 80, 23, 119, 3, 94, 86, 86, 2, 71, 3}, "31c3f2", 5995);
    ...
    public static void setDefaultNightMode(int i) {
        switch (i) {
            ...
            case 3:
                ...
                break;
            default:
                Log.d(TAG, NPStringFog.decode(new byte[]{68, 81, 22, 124, 93, 2, 86, 65, 14, 76, 118, 13, 80, 92, 22, 117, 87, 0, 82, 28, 75, 24, 91, 5, 91, 88, 7, 92, 24, 19, 94, 64, 10, 24, 89, 10, 23, 65, 12, 83, 86, 11, 64, 90, 66, 85, 87, 0, 82}, "74b88d", 2.78944938E8d));
                break;
        }
    }
