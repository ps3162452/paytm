...
class DrawableContainer extends Drawable implements Drawable.Callback {
    ...
    private static final String TAG = NPStringFog.decode(new byte[]{119, 20, 80, 21, 80, 1, 95, 3, 114, 13, 95, 23, 82, 15, 95, 7, 67}, "3f1b1c", 20938);
        ...
        */
        final boolean setLayoutDirection(int r8, int r9) {
            ...
            L7:
                ...
                if (r0 < r6) goto L25
                r0 = r5[r3]
                boolean r0 = androidx.core.graphics.drawable.DrawableCompat.setLayoutDirection(r0, r8)
            L19:
                if (r3 != r9) goto L23
            L1b:
                int r1 = r3 + 1
            ...
            L25:
                ...
                goto L19
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.graphics.drawable.DrawableContainer.DrawableContainerState.setLayoutDirection(int, int):boolean");
        }
        ...
        if (this.mEnterAnimationEnd != 0 || this.mExitAnimationEnd != 0) {
            ...
            if (runnable == null) {
                this.mAnimationRunnable = new Runnable(this) { // from class: androidx.appcompat.graphics.drawable.DrawableContainer.1
                    ...
                    public void run() {
                        this.this$0.animate(DrawableContainer.DEFAULT_DITHER);
