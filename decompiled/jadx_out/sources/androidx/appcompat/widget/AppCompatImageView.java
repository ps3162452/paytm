...
public class AppCompatImageView extends ImageView implements TintableBackgroundView, TintableImageSourceView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatImageView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mBackgroundTintId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{85, 87, 0, 90, 86, 71, 88, 67, 13, 85, 101, 92, 89, 66}, "76c115", false, false), R.attr.backgroundTint);
            this.mBackgroundTintModeId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{0, 5, 7, 95, 94, 16, 13, 17, 10, 80, 109, 11, 12, 16, 41, 91, 93, 7}, "bdd49b", 2.050731862E9d), R.attr.backgroundTintMode);
            this.mTintId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{68, 95, 93, 64}, "063482", -7455), R.attr.tint);
            this.mTintModeId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{68, 94, 10, 21, 127, 88, 84, 82}, "07da27", false), R.attr.tintMode);
