...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    private static final String TAG = NPStringFog.decode(new byte[]{36, 91, 66, 80, 86, 91, 39, 89, 68, 118, 79, 80, 23, 84, 87, 64, 117, 84, 28, 87, 67, 77}, "e86995", true, false);
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        throw new IllegalStateException(NPStringFog.decode(new byte[]{113, 4, 94, 30, 66, 68, 95, 4, 91, 92, 22, 5, 18, 1, 85, 90, 89, 22, 18, 17, 95, 86, 90, 6, 83, 23, 16, 86, 67, 16, 18, 10, 86, 25}, "2e096d", 380925474L) + view.getClass().getSimpleName());
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (!this.mOverlayMode && !z) {
            ...
            this.mInnerInsets = new WindowInsetsCompat.Builder(this.mInnerInsets).setSystemWindowInsets(Insets.of(this.mInnerInsets.getSystemWindowInsetLeft(), measuredHeight + this.mInnerInsets.getSystemWindowInsetTop(), this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom() + 0)).build();
        } else {
