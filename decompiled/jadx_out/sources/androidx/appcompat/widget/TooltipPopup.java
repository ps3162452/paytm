...
class TooltipPopup {
    private static final String TAG = NPStringFog.decode(new byte[]{100, 95, 89, 8, 23, 80, 64, 96, 89, 20, 22, 73}, "006dc9", 2.4296882E8f);
    ...
    private void computePosition(View view, int i, int i2, boolean z, WindowManager.LayoutParams layoutParams) {
        ...
        if (appRootView == null) {
            Log.e(TAG, NPStringFog.decode(new byte[]{122, 85, 91, 15, 93, 70, 25, 82, 92, 15, 86, 18, 88, 68, 69, 65, 68, 91, 92, 67}, "945a22", 971125736L));
            return;
        }
        appRootView.getWindowVisibleDisplayFrame(this.mTmpDisplayFrame);
        if (this.mTmpDisplayFrame.left < 0 && this.mTmpDisplayFrame.top < 0) {
            Resources resources = this.mContext.getResources();
            int identifier = resources.getIdentifier(NPStringFog.decode(new byte[]{65, 76, 89, 70, 70, 22, 109, 90, 89, 64, 108, 13, 87, 81, 95, 90, 71}, "28823e", true, true), NPStringFog.decode(new byte[]{92, 93, 91, 86, 86}, "84638b", 5.7588397E7d), NPStringFog.decode(new byte[]{87, 91, 0, 67, 86, 81, 82}, "65d198", 3.3885078E8f));
    ...
    void hide() {
        if (isShowing()) {
            ((WindowManager) this.mContext.getSystemService(NPStringFog.decode(new byte[]{68, 81, 90, 93, 11, 21}, "3849db", -1.5649158E9f))).removeView(this.mContentView);
        }
    }
    ...
    void show(View view, int i, int i2, boolean z, CharSequence charSequence) {
        ...
        ((WindowManager) this.mContext.getSystemService(NPStringFog.decode(new byte[]{18, 13, 15, 81, 90, 66}, "eda555", -3.70679523E8d))).addView(this.mContentView, this.mLayoutParams);
    }
}
