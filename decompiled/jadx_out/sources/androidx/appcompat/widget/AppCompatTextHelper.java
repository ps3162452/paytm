...
class AppCompatTextHelper {
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray tintTypedArray) {
        ...
        if (!context.isRestricted()) {
            try {
                Typeface font = tintTypedArray.getFont(i2, this.mStyle, new ResourcesCompat.FontCallback(this, i3, i4, new WeakReference(this.mView)) { // from class: androidx.appcompat.widget.AppCompatTextHelper.1
                    ...
                    public void onFontRetrieved(Typeface typeface) {
                        ...
                        if (Build.VERSION.SDK_INT >= 28 && (i5 = this.val$fontWeight) != -1) {
                            typeface = Typeface.create(typeface, i5, (this.val$style & 2) != 0);
                        }
    ...
    void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        if (resourceId != -1) {
            ...
            if (!z && tintTypedArrayObtainStyledAttributes2.hasValue(R.styleable.TextAppearance_textAllCaps)) {
                z3 = true;
            ...
            if (Build.VERSION.SDK_INT < 23) {
                colorStateList = tintTypedArrayObtainStyledAttributes2.hasValue(R.styleable.TextAppearance_android_textColor) ? tintTypedArrayObtainStyledAttributes2.getColorStateList(R.styleable.TextAppearance_android_textColor) : null;
                ColorStateList colorStateList4 = tintTypedArrayObtainStyledAttributes2.hasValue(R.styleable.TextAppearance_android_textColorHint) ? tintTypedArrayObtainStyledAttributes2.getColorStateList(R.styleable.TextAppearance_android_textColorHint) : null;
                if (tintTypedArrayObtainStyledAttributes2.hasValue(R.styleable.TextAppearance_android_textColorLink)) {
                    colorStateList3 = colorStateList4;
                    colorStateList2 = tintTypedArrayObtainStyledAttributes2.getColorStateList(R.styleable.TextAppearance_android_textColorLink);
                } else {
                    colorStateList3 = colorStateList4;
        ...
        if (!z && tintTypedArrayObtainStyledAttributes3.hasValue(R.styleable.TextAppearance_textAllCaps)) {
        ...
        if (Build.VERSION.SDK_INT < 23) {
            ...
            if (tintTypedArrayObtainStyledAttributes3.hasValue(R.styleable.TextAppearance_android_textColorHint)) {
                colorStateList3 = tintTypedArrayObtainStyledAttributes3.getColorStateList(R.styleable.TextAppearance_android_textColorHint);
            }
        ...
        if (this.mAsyncFontPending) {
            ...
            if (textView != null) {
                if (ViewCompat.isAttachedToWindow(textView)) {
                    textView.post(new Runnable(this, textView, typeface, this.mStyle) { // from class: androidx.appcompat.widget.AppCompatTextHelper.2
                        final AppCompatTextHelper this$0;
                        final int val$style;
