...
public class AppCompatToggleButton extends ToggleButton implements TintableBackgroundView, EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatToggleButton> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mBackgroundTintId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{84, 88, 80, 13, 4, 20, 89, 76, 93, 2, 55, 15, 88, 77}, "693fcf", 1.310072E9f), R.attr.backgroundTint);
            this.mBackgroundTintModeId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{3, 81, 1, 15, 2, 66, 14, 69, 12, 0, 49, 89, 15, 68, 47, 11, 1, 85}, "a0bde0", false), R.attr.backgroundTintMode);
