...
public class AppCompatEditText extends EditText implements TintableBackgroundView, OnReceiveContentViewBehavior, EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatEditText> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mBackgroundTintId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{90, 0, 82, 10, 81, 67, 87, 20, 95, 5, 98, 88, 86, 21}, "8a1a61", true), R.attr.backgroundTint);
            this.mBackgroundTintModeId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{3, 87, 81, 90, 6, 20, 14, 67, 92, 85, 53, 15, 15, 66, 127, 94, 5, 3}, "a621af", -4.53421282E8d), R.attr.backgroundTintMode);
