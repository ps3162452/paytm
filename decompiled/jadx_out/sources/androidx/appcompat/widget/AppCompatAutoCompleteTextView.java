...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements TintableBackgroundView, EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatAutoCompleteTextView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mBackgroundTintId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{82, 88, 85, 92, 87, 23, 95, 76, 88, 83, 100, 12, 94, 77}, "09670e", false), androidx.appcompat.R.attr.backgroundTint);
            this.mBackgroundTintModeId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{84, 85, 86, 91, 82, 74, 89, 65, 91, 84, 97, 81, 88, 64, 120, 95, 81, 93}, "645058", 1743971359L), androidx.appcompat.R.attr.backgroundTintMode);
