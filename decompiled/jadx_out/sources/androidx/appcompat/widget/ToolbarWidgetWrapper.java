...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    private static final String TAG = NPStringFog.decode(new byte[]{55, 95, 12, 84, 90, 89, 17, 103, 10, 92, 95, 93, 23, 103, 17, 89, 72, 72, 6, 66}, "c0c888", -8.370324E8f);
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean z, int i, int i2) {
        ...
        this.mToolbar.setNavigationOnClickListener(new View.OnClickListener(this) { // from class: androidx.appcompat.widget.ToolbarWidgetWrapper.1
            ...
            {
                this.this$0 = this;
                this.mNavItem = new ActionMenuItem(this.mToolbar.getContext(), 0, android.R.id.home, 0, 0, this.mTitle);
            }
    ...
    private void updateToolbarLogo() {
        ...
        if ((i & 2) != 0 && ((i & 1) == 0 || (drawable = this.mLogo) == null)) {
            drawable = this.mIcon;
        }
    ...
    public void initIndeterminateProgress() {
        Log.i(TAG, NPStringFog.decode(new byte[]{51, 75, 86, 95, 67, 81, 16, 74, 25, 92, 88, 71, 19, 85, 88, 65, 17, 65, 13, 74, 76, 72, 65, 91, 17, 77, 92, 92}, "c99814", 32522));
    }

    @Override // androidx.appcompat.widget.DecorToolbar
    public void initProgress() {
        Log.i(TAG, NPStringFog.decode(new byte[]{105, 65, 89, 2, 17, 83, 74, 64, 22, 1, 10, 69, 73, 95, 87, 28, 67, 67, 87, 64, 67, 21, 19, 89, 75, 71, 83, 1}, "936ec6", true));
    }
    ...
    public void setDropdownSelectedPosition(int i) {
        Spinner spinner = this.mSpinner;
        if (spinner == null) {
            throw new IllegalStateException(NPStringFog.decode(new byte[]{122, 84, 95, 67, 18, 18, 74, 80, 69, 68, 2, 64, 86, 69, 85, 11, 17, 92, 25, 70, 84, 8, 3, 81, 77, 80, 85, 68, 22, 93, 74, 92, 69, 13, 9, 92, 25, 66, 88, 16, 14, 93, 76, 65, 17, 5, 8, 18, 88, 81, 80, 20, 18, 87, 75}, "951df2", false));
        }
        ...
        if (i != i2) {
            ...
            switch (i) {
                ...
                case 2:
                    ...
                    return;
                default:
                    throw new IllegalArgumentException(NPStringFog.decode(new byte[]{112, 12, 68, 2, 84, 93, 93, 66, 92, 2, 78, 93, 94, 3, 70, 10, 87, 90, 25, 15, 93, 7, 93, 20}, "9b2c84", 1.3422168E9f) + i);
            }
        }
    }
