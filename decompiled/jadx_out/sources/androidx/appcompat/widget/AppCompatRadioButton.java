...
public class AppCompatRadioButton extends RadioButton implements TintableCompoundButton, TintableBackgroundView, EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatRadioButton> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mBackgroundTintId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{4, 2, 86, 89, 6, 19, 9, 22, 91, 86, 53, 8, 8, 23}, "fc52aa", -1961400647L), R.attr.backgroundTint);
            this.mBackgroundTintModeId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{0, 81, 82, 8, 82, 20, 13, 69, 95, 7, 97, 15, 12, 68, 124, 12, 81, 3}, "b01c5f", true), R.attr.backgroundTintMode);
            this.mButtonTintId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{1, 64, 67, 70, 93, 88, 55, 92, 89, 70}, "c57226", -3.25756202E8d), R.attr.buttonTint);
            this.mButtonTintModeId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{90, 67, 66, 71, 92, 88, 108, 95, 88, 71, 126, 89, 92, 83}, "866336", -1.3615045E9f), R.attr.buttonTintMode);
