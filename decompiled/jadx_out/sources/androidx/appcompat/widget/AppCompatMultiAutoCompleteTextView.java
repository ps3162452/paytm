...
public class AppCompatMultiAutoCompleteTextView extends MultiAutoCompleteTextView implements TintableBackgroundView, EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatMultiAutoCompleteTextView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mBackgroundTintId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{82, 7, 81, 95, 84, 67, 95, 19, 92, 80, 103, 88, 94, 18}, "0f2431", true, true), androidx.appcompat.R.attr.backgroundTint);
            this.mBackgroundTintModeId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{81, 0, 81, 82, 83, 64, 92, 20, 92, 93, 96, 91, 93, 21, 127, 86, 80, 87}, "3a2942", -31352), androidx.appcompat.R.attr.backgroundTintMode);
