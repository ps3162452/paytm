...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public void initForMode(ActionMode actionMode) {
        ...
        viewFindViewById.setOnClickListener(new View.OnClickListener(this, actionMode) { // from class: androidx.appcompat.widget.ActionBarContextView.1
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (View.MeasureSpec.getMode(i) != 1073741824) {
            throw new IllegalStateException(getClass().getSimpleName() + NPStringFog.decode(new byte[]{23, 80, 84, 93, 67, 14, 89, 95, 76, 19, 1, 4, 23, 70, 70, 86, 7, 65, 64, 90, 65, 91, 67, 0, 89, 87, 71, 92, 10, 5, 13, 95, 84, 74, 12, 20, 67, 108, 66, 90, 7, 21, 95, 14, 23, 94, 2, 21, 84, 91, 106, 67, 2, 19, 82, 93, 65, 17, 67, 73, 88, 65, 21, 85, 10, 13, 91, 108, 69, 82, 17, 4, 89, 71, 28}, "7353ca", true, false));
        }
        if (View.MeasureSpec.getMode(i2) == 0) {
            throw new IllegalStateException(getClass().getSimpleName() + NPStringFog.decode(new byte[]{20, 87, 7, 92, 68, 89, 90, 88, 31, 18, 6, 83, 20, 65, 21, 87, 0, 22, 67, 93, 18, 90, 68, 87, 90, 80, 20, 93, 13, 82, 14, 88, 7, 75, 11, 67, 64, 107, 14, 87, 13, 81, 92, 64, 91, 16, 19, 68, 85, 68, 57, 81, 11, 88, 64, 81, 8, 70, 70}, "44f2d6", true, false));
        }
