...
public class AppCompatImageButton extends ImageButton implements TintableBackgroundView, TintableImageSourceView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatImageButton> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mBackgroundTintId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{84, 4, 7, 94, 6, 22, 89, 16, 10, 81, 53, 13, 88, 17}, "6ed5ad", 23603), R.attr.backgroundTint);
            this.mBackgroundTintModeId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{81, 84, 85, 93, 3, 69, 92, 64, 88, 82, 48, 94, 93, 65, 123, 89, 0, 82}, "3566d7", 17741), R.attr.backgroundTintMode);
            this.mTintId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{64, 81, 86, 68}, "48806c", -1.723009E9f), R.attr.tint);
            this.mTintModeId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{66, 91, 13, 77, 47, 94, 82, 87}, "62c9b1", true, true), R.attr.tintMode);
