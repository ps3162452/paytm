...
public class AppCompatCheckBox extends CheckBox implements TintableCompoundButton, TintableBackgroundView, EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatCheckBox> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mBackgroundTintId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{3, 84, 82, 13, 1, 67, 14, 64, 95, 2, 50, 88, 15, 65}, "a51ff1", false), R.attr.backgroundTint);
            this.mBackgroundTintModeId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{82, 86, 81, 92, 82, 69, 95, 66, 92, 83, 97, 94, 94, 67, 127, 88, 81, 82}, "072757", true, true), R.attr.backgroundTintMode);
            this.mButtonTintId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{87, 65, 66, 22, 86, 91, 97, 93, 88, 22}, "546b95", -1.262280154E9d), R.attr.buttonTint);
            this.mButtonTintModeId = propertyMapper.mapObject(NPStringFog.decode(new byte[]{87, 68, 70, 67, 90, 91, 97, 88, 92, 67, 120, 90, 81, 84}, "512755", true, true), R.attr.buttonTintMode);
