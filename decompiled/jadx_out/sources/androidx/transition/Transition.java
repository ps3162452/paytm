...
public abstract class Transition implements Cloneable {
    ...
    private static final String LOG_TAG = NPStringFog.decode(new byte[]{97, 67, 86, 12, 65, 15, 65, 88, 88, 12}, "517b2f", 8.601953E8f);
    private static final String MATCH_ID_STR = NPStringFog.decode(new byte[]{91, 81}, "25a806", true);
    private static final String MATCH_INSTANCE_STR = NPStringFog.decode(new byte[]{15, 95, 66, 22, 81, 11, 5, 84}, "f11b0e", 1.688523306E9d);
    private static final String MATCH_ITEM_ID_STR = NPStringFog.decode(new byte[]{89, 69, 3, 9, 127, 83}, "01fd67", true, false);
    private static final String MATCH_NAME_STR = NPStringFog.decode(new byte[]{11, 88, 11, 84}, "e9f150", 8.029751E8f);
    ...
    public Transition(@NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        long namedInt = TypedArrayUtils.getNamedInt(typedArrayObtainStyledAttributes, xmlResourceParser, NPStringFog.decode(new byte[]{87, 19, 20, 81, 17, 81, 92, 8}, "3ff0e8", 4146), 1, -1);
        if (namedInt >= 0) {
            setDuration(namedInt);
        }
        long namedInt2 = TypedArrayUtils.getNamedInt(typedArrayObtainStyledAttributes, xmlResourceParser, NPStringFog.decode(new byte[]{23, 21, 0, 16, 18, 113, 1, 13, 0, 27}, "daabf5", false, true), 2, -1);
        if (namedInt2 > 0) {
            setStartDelay(namedInt2);
        }
        int namedResourceId = TypedArrayUtils.getNamedResourceId(typedArrayObtainStyledAttributes, xmlResourceParser, NPStringFog.decode(new byte[]{80, 89, 76, 93, 22, 17, 86, 91, 89, 76, 11, 19}, "9788da", true), 0, 0);
        if (namedResourceId > 0) {
            setInterpolator(AnimationUtils.loadInterpolator(context, namedResourceId));
        }
        String namedString = TypedArrayUtils.getNamedString(typedArrayObtainStyledAttributes, xmlResourceParser, NPStringFog.decode(new byte[]{9, 87, 67, 81, 91, 123, 22, 82, 82, 64}, "d67234", true), 3);
        if (namedString != null) {
    ...
    private static int[] parseMatchOrder(String str) {
        StringTokenizer stringTokenizer = new StringTokenizer(str, NPStringFog.decode(new byte[]{72}, "db2087", -21267));
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (MATCH_ID_STR.equalsIgnoreCase(strTrim)) {
                ...
                if (!strTrim.isEmpty()) {
                    throw new InflateException(NPStringFog.decode(new byte[]{55, 88, 90, 89, 91, 78, 12, 22, 92, 86, 64, 90, 10, 22, 69, 78, 68, 92, 66, 95, 95, 23, 89, 88, 22, 85, 89, 120, 70, 93, 7, 68, 11, 23, 19}, "b61749", -15785) + strTrim + NPStringFog.decode(new byte[]{66}, "e1cdc1", -16648));
                }
    ...
    */
    androidx.transition.TransitionValues getMatchedTransitionValues(android.view.View r7, boolean r8) {
        /*
            ...
            if (r0 == 0) goto Lc
            androidx.transition.TransitionSet r0 = r6.mParent
            androidx.transition.TransitionValues r0 = r0.getMatchedTransitionValues(r7, r8)
        Lb:
            return r0
        Lc:
            if (r8 == 0) goto L15
    ...
    public void setMatchOrder(int... iArr) {
        ...
        for (int i = 0; i < iArr.length; i++) {
            if (!isValidMatch(iArr[i])) {
                throw new IllegalArgumentException(NPStringFog.decode(new byte[]{93, 82, 65, 85, 94, 87, 67, 19, 86, 89, 88, 70, 81, 90, 91, 69, 22, 91, 94, 69, 84, 90, 95, 86, 16, 69, 84, 90, 67, 87}, "035662", 8908));
            }
            if (alreadyContains(iArr, i)) {
                throw new IllegalArgumentException(NPStringFog.decode(new byte[]{95, 88, 77, 82, 13, 93, 65, 25, 90, 94, 11, 76, 83, 80, 87, 66, 69, 89, 18, 93, 76, 65, 9, 81, 81, 88, 77, 84, 69, 78, 83, 85, 76, 84}, "2991e8", 5.85335526E8d));
            }
        }
    ...
    String toString(String str) {
        String str2;
        String str3 = str + getClass().getSimpleName() + NPStringFog.decode(new byte[]{37}, "e96b68", -1794572067L) + Integer.toHexString(hashCode()) + NPStringFog.decode(new byte[]{8, 21}, "25af21", 296);
        if (this.mDuration != -1) {
            str3 = str3 + NPStringFog.decode(new byte[]{87, 69, 71, 77}, "305e2f", 22225) + this.mDuration + NPStringFog.decode(new byte[]{28, 24}, "58463a", -1.0745206E9f);
        }
        if (this.mStartDelay != -1) {
            str3 = str3 + NPStringFog.decode(new byte[]{7, 14, 65, 77}, "cb8e86", 4443) + this.mStartDelay + NPStringFog.decode(new byte[]{79, 23}, "f7bebd", -907884054L);
        }
        if (this.mInterpolator != null) {
            str3 = str3 + NPStringFog.decode(new byte[]{15, 86, 77, 80, 19, 69, 78}, "f895a5", -3170) + this.mInterpolator + NPStringFog.decode(new byte[]{27, 18}, "222423", false);
        }
        if (this.mTargetIds.size() <= 0 && this.mTargets.size() <= 0) {
            return str3;
        }
        String str4 = str3 + NPStringFog.decode(new byte[]{71, 94, 16, 16, 28}, "39dc4a", true, false);
        if (this.mTargetIds.size() > 0) {
            str2 = str4;
            for (int i = 0; i < this.mTargetIds.size(); i++) {
                if (i > 0) {
                    str2 = str2 + NPStringFog.decode(new byte[]{24, 17}, "418f1e", false, true);
                }
        ...
        if (this.mTargets.size() > 0) {
            for (int i2 = 0; i2 < this.mTargets.size(); i2++) {
                if (i2 > 0) {
                    str2 = str2 + NPStringFog.decode(new byte[]{24, 20}, "44cf72", 1.736091841E9d);
                }
                str2 = str2 + this.mTargets.get(i2);
            }
        }
        return str2 + NPStringFog.decode(new byte[]{26}, "3db3a5", -1567335099L);
    }
}
