...
public class Slide extends Visibility {
    ...
    private static final String PROPNAME_SCREEN_POSITION = NPStringFog.decode(new byte[]{84, 12, 80, 17, 14, 15, 81, 88, 71, 15, 8, 2, 80, 88, 71, 0, 19, 3, 80, 12, 100, 12, 18, 15, 65, 11, 91, 13}, "5b4caf", 1421330391L);
    ...
    public Slide(@NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        int namedInt = TypedArrayUtils.getNamedInt(typedArrayObtainStyledAttributes, (XmlPullParser) attributeSet, NPStringFog.decode(new byte[]{64, 10, 12, 92, 84, 124, 87, 1, 0}, "3fe819", -1.702192599E9d), 0, 80);
    ...
    public void setSlideEdge(int i) {
        switch (i) {
            ...
            case GravityCompat.END /* 8388613 */:
                ...
                break;
            default:
                throw new IllegalArgumentException(NPStringFog.decode(new byte[]{127, 94, 78, 81, 90, 91, 82, 16, 75, 92, 95, 86, 83, 16, 92, 89, 68, 87, 85, 68, 81, 95, 88}, "608062", 8700));
        }
        this.mSlideEdge = i;
