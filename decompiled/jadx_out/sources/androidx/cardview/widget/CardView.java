    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mCardViewDelegate = new CardViewDelegate(this) { // from class: androidx.cardview.widget.CardView.1
            ...
            public void setShadowPadding(int i2, int i3, int i4, int i5) {
                ...
                CardView.super.setPadding(this.this$0.mContentPadding.left + i2, this.this$0.mContentPadding.top + i3, this.this$0.mContentPadding.right + i4, this.this$0.mContentPadding.bottom + i5);
            }
        };
