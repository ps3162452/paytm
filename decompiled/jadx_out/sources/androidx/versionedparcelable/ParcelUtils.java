...
public class ParcelUtils {
    private static final String INNER_BUNDLE_KEY = NPStringFog.decode(new byte[]{5}, "d088b9", true);
    ...
    public static <T extends VersionedParcelable> T fromParcelable(Parcelable parcelable) {
        ...
        throw new IllegalArgumentException(NPStringFog.decode(new byte[]{44, 11, 64, 3, 15, 15, 1, 69, 70, 3, 17, 5, 0, 9}, "ee6bcf", 2026460721L));
    }
