...
class VersionedParcelParcel extends VersionedParcel {
    ...
    private static final String TAG = NPStringFog.decode(new byte[]{103, 84, 22, 65, 90, 90, 95, 84, 0, 98, 82, 71, 82, 84, 8, 98, 82, 71, 82, 84, 8}, "11d235", true);
    ...
    public boolean readField(int i) {
        while (this.mNextRead < this.mEnd) {
            ...
            this.mNextRead = i3 + this.mNextRead;
        }
