...
public class FlexBuffers {
    ...
    public static class KeyVector {
        ...
        public Key get(int i) {
            ...
            return new Key(this.vec.bb, FlexBuffers.indirect(this.vec.bb, this.vec.end + (this.vec.byteWidth * i), this.vec.byteWidth), 1);
        }
        ...
        public String toString() {
            ...
            for (int i = 0; i < this.vec.size(); i++) {
                ...
                if (i != this.vec.size() - 1) {
                    sb.append(NPStringFog.decode(new byte[]{20, 18}, "82f1e3", 896749057L));
                }
            }
            return sb.append(NPStringFog.decode(new byte[]{109}, "08e91b", 1204184449L)).toString();
        }
    }
    ...
    public static class Map extends Vector {
        ...
        public StringBuilder toString(StringBuilder sb) {
            sb.append(NPStringFog.decode(new byte[]{73, 25}, "29e3e2", -9.37804322E8d));
            KeyVector keyVectorKeys = keys();
            int size = size();
            Vector vectorValues = values();
            for (int i = 0; i < size; i++) {
                sb.append('\"').append(keyVectorKeys.get(i).toString()).append(NPStringFog.decode(new byte[]{68, 19, 14, 24}, "f34810", false, false));
                sb.append(vectorValues.get(i).toString());
                if (i != size - 1) {
                    sb.append(NPStringFog.decode(new byte[]{25, 69}, "5ebac2", -1.231197056E9d));
                }
            }
            sb.append(NPStringFog.decode(new byte[]{19, 25}, "3d29be", 971038186L));
            return sb;
        }
    ...
    public static class Reference {
        ...
        StringBuilder toString(StringBuilder sb) {
            switch (this.type) {
                case 0:
                    return sb.append(NPStringFog.decode(new byte[]{86, 68, 85, 85}, "81998a", 1458955953L));
                case 1:
                case 6:
                ...
                case 23:
                case 24:
                    throw new FlexBufferException(NPStringFog.decode(new byte[]{87, 9, 67, 62, 89, 93, 73, 10, 82, 12, 85, 94, 77, 3, 83, 91}, "9f7a00", -1582591477L) + this.type);
                case 25:
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.bb, this.end + (this.byteWidth * i), this.byteWidth, 1, this.elemType);
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.bb, this.end + (this.byteWidth * i), this.byteWidth, Unsigned.byteToUnsignedInt(this.bb.get((int) ((size * ((long) this.byteWidth)) + ((long) this.end) + ((long) i)))));
        }
        ...
        @Override // androidx.emoji2.text.flatbuffer.FlexBuffers.Object
        public StringBuilder toString(StringBuilder sb) {
            sb.append(NPStringFog.decode(new byte[]{57, 65}, "bab264", 1903005222L));
            int size = size();
            for (int i = 0; i < size; i++) {
                get(i).toString(sb);
                if (i != size - 1) {
                    sb.append(NPStringFog.decode(new byte[]{74, 68}, "fd16cf", true, true));
                }
            }
            sb.append(NPStringFog.decode(new byte[]{16, 109}, "00e8bb", 5.57353351E8d));
            return sb;
        }
    }
