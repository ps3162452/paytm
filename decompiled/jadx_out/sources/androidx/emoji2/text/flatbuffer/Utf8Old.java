...
public class Utf8Old extends Utf8 {
    ...
    public String decodeUtf8(ByteBuffer byteBuffer, int i, int i2) {
        ...
        try {
            ...
            throw new IllegalArgumentException(NPStringFog.decode(new byte[]{112, 0, 81, 65, 6, 94, 81, 14, 81, 8, 13, 87}, "2a5ac0", false, false), e);
        }
    }
    ...
    public int encodedLength(CharSequence charSequence) {
        ...
        if (coderResultEncode.isError()) {
            try {
                ...
                throw new IllegalArgumentException(NPStringFog.decode(new byte[]{6, 0, 80, 23, 81, 9, 5, 19, 85, 84, 70, 4, 22, 65, 81, 89, 81, 14, 0, 8, 90, 80}, "da472a", -1.27348673E9d), e);
            }
        }
