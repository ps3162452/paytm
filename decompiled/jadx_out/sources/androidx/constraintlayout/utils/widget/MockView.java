...
public class MockView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mDrawDiagonals) {
            int i2 = width - 1;
            int i3 = height - 1;
            canvas.drawLine(0.0f, 0.0f, i2, i3, this.mPaintDiagonals);
            canvas.drawLine(0.0f, i3, i2, 0.0f, this.mPaintDiagonals);
            canvas.drawLine(0.0f, 0.0f, i2, 0.0f, this.mPaintDiagonals);
            canvas.drawLine(i2, 0.0f, i2, i3, this.mPaintDiagonals);
            canvas.drawLine(i2, i3, 0.0f, i3, this.mPaintDiagonals);
            canvas.drawLine(0.0f, i3, 0.0f, 0.0f, this.mPaintDiagonals);
            height = i3;
            i = i2;
        } else {
            i = width;
        ...
        float fWidth = (i - this.mTextBounds.width()) / 2.0f;
