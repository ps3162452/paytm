...
public class State {
    ...
    private String createHelperKey() {
        ...
        sb.append(NPStringFog.decode(new byte[]{61, 102, 42, 32, 121, 103, 39, 107, 61, 46, 112, 110, 61}, "b9be57", 1.7112769E9f));
        int i = this.numHelpers;
        this.numHelpers = i + 1;
        sb.append(i);
        sb.append(NPStringFog.decode(new byte[]{58, 107}, "e49672", true));
        return sb.toString();
    }
            ...
            if (reference3 != this.mParent && (reference3.getFacade() instanceof HelperReference) && (helperWidget = (helperReference = (HelperReference) reference3.getFacade()).getHelperWidget()) != null) {
                for (Object obj3 : helperReference.mReferences) {
                    ...
                    if (reference4 != null) {
                        ...
                        System.out.println(NPStringFog.decode(new byte[]{5, 89, 20, 15, 5, 93, 65, 66, 65, 5, 8, 93, 2, 22, 19, 6, 7, 86, 20, 83, 15, 0, 4, 19, 0, 89, 19, 67}, "f6aca3", 6.87065671E8d) + obj3);
                    }
                }
                reference3.apply();
            }
    ...
    public HelperReference helper(Object obj, Helper helper) {
        ...
        if (horizontalChainReference == null) {
            switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Helper[helper.ordinal()]) {
                case 1:
