...
public abstract class KeyCycleOscillator {
    private static final String TAG = NPStringFog.decode(new byte[]{40, 7, 73, 116, 27, 82, 15, 7, 127, 68, 1, 88, 15, 14, 81, 67, 13, 67}, "cb07b1", 29667);
    ...
    static class CycleOscillator {
        private static final String TAG = NPStringFog.decode(new byte[]{38, 76, 90, 85, 80, 125, 22, 86, 80, 85, 89, 83, 17, 90, 75}, "e59952", -2023906149L);
        ...
        public double getSlope(float f) {
            ...
            return (slope * this.mSplineValueCache[2]) + (dArr2[2] * value) + dArr2[0];
        }
    ...
    public static KeyCycleOscillator makeWidgetCycle(String str) {
        return str.equals(NPStringFog.decode(new byte[]{72, 85, 21, 95, 51, 92, 76, 85, 21, 82}, "84a7a3", 7414)) ? new PathRotateSet(str) : new CoreSpline(str);
    }
    ...
    public String toString() {
        ...
        DecimalFormat decimalFormat = new DecimalFormat(NPStringFog.decode(new byte[]{23, 64, 74, 17, 23}, "4cd247", -3.35061034E8d));
        ...
        while (true) {
            ...
            str = str2 + NPStringFog.decode(new byte[]{99}, "8a070b", true, true) + it.next().mPosition + NPStringFog.decode(new byte[]{22, 20, 24}, "688115", -157420404L) + decimalFormat.format(r0.mValue) + NPStringFog.decode(new byte[]{59, 24}, "f8080b", -3.73858818E8d);
        }
    }
