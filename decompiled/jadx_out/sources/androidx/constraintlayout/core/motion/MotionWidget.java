...
public class MotionWidget implements TypedValues {
    ...
    public String toString() {
        return this.widgetFrame.left + NPStringFog.decode(new byte[]{27, 23}, "7785fd", false) + this.widgetFrame.top + NPStringFog.decode(new byte[]{78, 17}, "b1e676", true, false) + this.widgetFrame.right + NPStringFog.decode(new byte[]{72, 66}, "dbc64c", -2.0159146E9f) + this.widgetFrame.bottom;
    }
}
