...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    private static final String ANIMATED_VECTOR = NPStringFog.decode(new byte[]{5, 90, 95, 89, 7, 65, 1, 80, 27, 66, 3, 86, 16, 91, 68}, "d464f5", -657435197L);
    private static final String LOGTAG = NPStringFog.decode(new byte[]{34, 11, 94, 95, 84, 16, 6, 1, 97, 118, 118, 11, 14, 21, 86, 70}, "ce725d", true, false);
    private static final String TARGET = NPStringFog.decode(new byte[]{16, 82, 69, 84, 85, 65}, "d37305", false, false);
    ...
    private static class AnimatedVectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public Drawable newDrawable() {
            throw new IllegalStateException(NPStringFog.decode(new byte[]{47, 91, 67, 85, 9, 13, 18, 64, 2, 88, 18, 67, 18, 64, 2, 66, 3, 67, 18, 65, 19, 70, 9, 17, 21, 20, 5, 89, 20, 67, 50, 112, 40, 22, 90, 67, 83, 0, 77}, "a4c6fc", false));
        }

        @Override // android.graphics.drawable.Drawable.ConstantState
        public Drawable newDrawable(Resources resources) {
            throw new IllegalStateException(NPStringFog.decode(new byte[]{122, 89, 16, 81, 86, 15, 71, 66, 81, 92, 77, 65, 71, 66, 81, 70, 92, 65, 71, 67, 64, 66, 86, 19, 64, 22, 86, 93, 75, 65, 103, 114, 123, 18, 5, 65, 6, 2, 30}, "46029a", -6.37025299E8d));
        }
    ...
    public static AnimatedVectorDrawableCompat create(@NonNull Context context, @DrawableRes int i) {
        ...
        try {
            ...
            if (next != 2) {
                throw new XmlPullParserException(NPStringFog.decode(new byte[]{40, 87, 22, 75, 77, 84, 20, 76, 22, 76, 88, 82, 70, 94, 89, 77, 87, 81}, "f86895", true, false));
            }
            return createFromXmlInner(context, context.getResources(), xml, attributeSetAsAttributeSet, context.getTheme());
        } catch (IOException e) {
            Log.e(LOGTAG, NPStringFog.decode(new byte[]{65, 2, 67, 75, 4, 71, 17, 6, 67, 74, 14, 71}, "1c18a5", true, false), e);
            return null;
        } catch (XmlPullParserException e2) {
            Log.e(LOGTAG, NPStringFog.decode(new byte[]{72, 2, 16, 68, 84, 75, 24, 6, 16, 69, 94, 75}, "8cb719", -16309), e2);
            return null;
        }
    }
    ...
    private void setupColorAnimator(Animator animator) {
        ...
        if (animator instanceof ObjectAnimator) {
            ...
            if (NPStringFog.decode(new byte[]{86, 15, 14, 94, 38, 9, 92, 9, 16}, "0fb2ef", 841144252L).equals(propertyName) || NPStringFog.decode(new byte[]{74, 18, 66, 95, 8, 86, 122, 9, 92, 95, 17}, "9f00c3", false, false).equals(propertyName)) {
                ...
                if (ANIMATED_VECTOR.equals(name)) {
                    ...
                    if (resourceId2 != 0) {
                        if (this.mContext == null) {
                            ...
                            throw new IllegalStateException(NPStringFog.decode(new byte[]{115, 94, 11, 66, 81, 76, 68, 17, 6, 87, 90, 19, 68, 17, 7, 83, 20, 90, 69, 93, 9, 22, 67, 92, 85, 95, 69, 95, 90, 82, 92, 80, 17, 95, 90, 83, 16, 80, 11, 95, 89, 85, 68, 94, 23, 69}, "01e644", 8.42865014E8d));
                        }
