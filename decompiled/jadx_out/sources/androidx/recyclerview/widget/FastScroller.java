...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    private final Runnable mHideRunnable = new Runnable(this) { // from class: androidx.recyclerview.widget.FastScroller.1
    ...
    private final RecyclerView.OnScrollListener mOnScrollListener = new RecyclerView.OnScrollListener(this) { // from class: androidx.recyclerview.widget.FastScroller.2
        final FastScroller this$0;
