...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    private static class ClampedScroller {
        ...
        private float getValueAt(long j) {
            ...
            if (j2 < 0 || j < j2) {
                return AutoScrollHelper.constrain((j - r2) / this.mRampUpDuration, 0.0f, 1.0f) * 0.5f;
            }
        ...
        public void computeScrollDelta() {
            if (this.mDeltaTime == 0) {
                throw new RuntimeException(NPStringFog.decode(new byte[]{37, 2, 94, 94, 14, 64, 70, 0, 95, 93, 17, 65, 18, 6, 16, 67, 2, 70, 9, 15, 92, 16, 5, 81, 10, 23, 81, 16, 3, 81, 0, 12, 66, 85, 65, 87, 7, 15, 92, 89, 15, 83, 70, 16, 68, 81, 19, 64, 78, 74}, "fc00a4", true, true));
            }
