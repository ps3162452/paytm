...
public class Person {
    private static final String ICON_KEY = NPStringFog.decode(new byte[]{91, 83, 89, 93}, "2063b4", -4.17933501E8d);
    private static final String IS_BOT_KEY = NPStringFog.decode(new byte[]{91, 66, 119, 14, 64}, "215a46", -8.434846E8f);
    private static final String IS_IMPORTANT_KEY = NPStringFog.decode(new byte[]{93, 69, 124, 11, 65, 95, 70, 66, 84, 8, 69}, "465f10", true, true);
    private static final String KEY_KEY = NPStringFog.decode(new byte[]{94, 92, 27}, "59b6c3", -1.409535E9f);
    private static final String NAME_KEY = NPStringFog.decode(new byte[]{87, 4, 8, 1}, "9eed48", true);
    private static final String URI_KEY = NPStringFog.decode(new byte[]{68, 23, 95}, "1e68fa", 24591);
    IconCompat mIcon;
    boolean mIsBot;
    ...
    public String resolveToLegacyUri() {
        ...
        return NPStringFog.decode(new byte[]{15, 83, 90, 3, 3}, "a27f97", true) + ((Object) this.mName);
    }
