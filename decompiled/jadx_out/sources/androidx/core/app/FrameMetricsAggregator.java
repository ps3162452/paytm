...
public class FrameMetricsAggregator {
    ...
    private static class FrameMetricsApi24Impl extends FrameMetricsBaseImpl {
        ...
        Window.OnFrameMetricsAvailableListener mListener = new Window.OnFrameMetricsAvailableListener(this) { // from class: androidx.core.app.FrameMetricsAggregator.FrameMetricsApi24Impl.1
        ...
        public void add(Activity activity) {
            if (sHandlerThread == null) {
                HandlerThread handlerThread = new HandlerThread(NPStringFog.decode(new byte[]{35, 22, 85, 84, 92, 44, 0, 16, 70, 80, 90, 18, 36, 3, 83, 75, 92, 6, 4, 16, 91, 75}, "ed499a", 2.144839824E9d));
