...
public class TypefaceCompat {
    ...
    public static Typeface create(Context context, Typeface typeface, int i) {
        ...
        throw new IllegalArgumentException(NPStringFog.decode(new byte[]{123, 94, 93, 22, 82, 65, 76, 17, 80, 3, 89, 87, 87, 69, 19, 0, 82, 25, 86, 68, 95, 14}, "813b79", -13566));
    }
    ...
    public static Typeface createFromResourcesFamilyXml(Context context, FontResourcesParserCompat.FamilyResourceEntry familyResourceEntry, Resources resources, int i, int i2, ResourcesCompat.FontCallback fontCallback, Handler handler, boolean z) {
        ...
        if (familyResourceEntry instanceof FontResourcesParserCompat.ProviderResourceEntry) {
            ...
            typefaceCreateFromFontFamilyFilesResourceEntry = getSystemFontFamily(providerResourceEntry.getSystemFontFamilyName());
    ...
    private static String createResourceUid(Resources resources, int i, int i2) {
        return resources.getResourcePackageName(i) + NPStringFog.decode(new byte[]{31}, "2e191c", true, false) + i + NPStringFog.decode(new byte[]{75}, "f312bb", -1.689434083E9d) + i2;
    }
