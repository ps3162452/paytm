...
public final class PaintCompat {
    private static final String EM_STRING = NPStringFog.decode(new byte[]{89}, "45b084", 15538);
    private static final String TOFU_STRING = NPStringFog.decode(new byte[]{-60, -87, -37, -116}, "76d1ce", -1434704382L);
