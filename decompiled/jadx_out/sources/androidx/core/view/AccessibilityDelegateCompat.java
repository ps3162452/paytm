...
public class AccessibilityDelegateCompat {
    ...
    public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
        ...
        return (zPerformAccessibilityAction || i != R.id.accessibility_action_clickable_span) ? zPerformAccessibilityAction : performClickableSpanAction(bundle.getInt(NPStringFog.decode(new byte[]{36, 114, 114, 38, 102, 49, 44, 115, 120, 47, 124, 54, 60, 110, 114, 47, 124, 33, 46, 112, 115, 47, 112, 61, 54, 97, 112, 45, 106, 43, 33}, "e11c5b", 13663), -1), view);
    }
