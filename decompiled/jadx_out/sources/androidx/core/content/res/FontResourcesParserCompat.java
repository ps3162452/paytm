...
public class FontResourcesParserCompat {
    ...
    public static FamilyResourceEntry parse(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        throw new XmlPullParserException(NPStringFog.decode(new byte[]{121, 10, 22, 65, 65, 86, 69, 17, 22, 70, 84, 80, 23, 3, 89, 71, 91, 83}, "7e6257", -31959));
    }
    ...
    private static FamilyResourceEntry readFamilies(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        xmlPullParser.require(2, null, NPStringFog.decode(new byte[]{80, 91, 92, 23, 79, 84, 87, 89, 91, 15, 27}, "642cb2", -1.9499103E9f));
        if (xmlPullParser.getName().equals(NPStringFog.decode(new byte[]{87, 14, 93, 16, 27, 81, 80, 12, 90, 8, 79}, "1a3d67", false))) {
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        while (xmlPullParser.next() != 3) {
            if (xmlPullParser.getEventType() == 2) {
                if (xmlPullParser.getName().equals(NPStringFog.decode(new byte[]{4, 94, 11, 66}, "b1e69e", 4.3869424E8f))) {
