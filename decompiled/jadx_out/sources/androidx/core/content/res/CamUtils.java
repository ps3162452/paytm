...
final class CamUtils {
    ...
    static int intFromLStar(float f) {
        ...
        return ColorUtils.XYZToColor(fArr[0] * f4, fArr[1] * f3, f5 * fArr[2]);
    }
    ...
    static float[] xyzFromInt(int i) {
        ...
        return new float[]{(fArr[0][0] * fLinearized) + (fArr[0][1] * fLinearized2) + (fArr[0][2] * fLinearized3), (fArr[1][0] * fLinearized) + (fArr[1][1] * fLinearized2) + (fArr[1][2] * fLinearized3), (fLinearized * fArr[2][0]) + (fLinearized2 * fArr[2][1]) + (fArr[2][2] * fLinearized3)};
    }
    ...
    static float yFromInt(int i) {
        ...
        float fLinearized3 = linearized(Color.blue(i));
        float[][] fArr = SRGB_TO_XYZ;
        return (fLinearized * fArr[1][0]) + (fLinearized2 * fArr[1][1]) + (fArr[1][2] * fLinearized3);
    }
